...
$(function() {
  ...
  $(".main-content").css({
    minHeight: $(window).outerHeight() - 57
  })
  ...
  var toggle_sidebar_mini = function(mini) {
    ...
    document.cookie='sidebar='+cookie;
  }
...
$(function () {
  ...
  const redirect = protocol + '//' + domain + '/pricing';
  ...
  $('.__pro__').tooltip({
    ...
    html: true,
    title:'<a href="'+ redirect +'" class="font-weight-bold text-success">Recharge Now</a> to get the access of our pro features.',
  });
