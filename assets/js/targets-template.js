...
function addTargetCss(){
    ...
    element.setAttribute("href", "https://mouthpublicity.io/assets/css/template-targets.css");
...
function addTargetBox(share_cnf,share_st){
    ...
    /*posting url xhttp*/
    xhttp.open("POST", "https://services.openchallenge.in/template-social-buttons", true);
...
function clickToCopyURL($url) {
    ...
    cond = ac.querySelector('SPAN') || false;
    if(!cond){
        var mg = document.createElement("SPAN");
        mg.innerHTML = 'Link Copied';
