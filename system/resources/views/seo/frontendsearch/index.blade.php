@extends('layouts.seo')
@section('title', 'SEO: Frontend Search List')
@section('head')
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-action-filter">
                ...
                <form method="post" class="basicform_with_reload" action="{{ route('seo.frontendSearch.destroys') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex">
                        ...
                        <div class="col-lg-6">
                            <div class="add-new-btn">
                                <a href="{{ route('seo.frontendsearch.create') }}"
                                ...
                                <tr id="front_end_search_id_{{ $search->id }}">
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-icon icon-left btn-primary"
                                            href="{{ route('seo.frontendsearch.edit', $search->id) }}"><i
                                                class="fa fa-edit"></i></a>
                                        <a class="btn btn-sm btn-icon icon-left btn-success"
                                            href="{{ route('seo.frontendsearch.show', $search->id) }}"><i
