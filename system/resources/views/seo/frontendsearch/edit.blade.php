@extends('layouts.seo')
@section('title', 'SEO: Edit Keyword')
@section('head')
...
<div class="row">
	<div class="col-lg-9">      
		<div class="card">
			<div class="card-body">
				<form id="pageEditform" method="post" action="{{ route('seo.frontendSearch.frontendSearchUpdate', $FrontEndSearch->id) }}" enctype="multipart/form-data">
					@csrf
