...
<script>
	CKEDITOR.replace('description',{
		filebrowserUploadUrl: "{{route('seo.ckeditordocumentation.upload', ['_token' => csrf_token() ])}}",
            ...
            $.ajax({
                ...
                success: function(response){ 
                    ...
                    if(response.status == true){
                        ...
                        setTimeout(function(){
                            window.location.href = '{{ route('seo.documentation.index') }}';
                        },2000);
                    }else{
...
<script type="text/javascript">  
 function add_tags(){
   ...
   if (tag != '') {      
		$.ajax({
			url : '{{ route('seo.documentations.add_tags') }}',
			type : 'POST',
