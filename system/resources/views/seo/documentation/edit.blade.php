...
<div class="row">
	<div class="col-lg-9">      
		<div class="card">
			<div class="card-body">
				<form id="documentationform" method="post" action="{{ route('seo.documentation.BUpdate',$documentationInfo->id) }}" enctype="multipart/form-data">
					@csrf
					<div class="custom-form pt-20">

						<div class="form-group">
							<label for="name">Title <span class="is_required">*</span></label>
							<input type="text" placeholder="Title" name="title" class="form-control" id="name" value="{{ $documentationInfo->title }}">
						</div>
