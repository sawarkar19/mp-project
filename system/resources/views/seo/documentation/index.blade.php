@extends('layouts.seo')
@section('title', 'SEO: Documentation List')
@section('head')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-action-filter">
                <form method="post" class="basicform_with_reload" action="{{ route('seo.documentations.destroys') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex">
                        ...
                        <div class="col-lg-6">
                            <div class="add-new-btn">
                                <a href="{{ route('seo.documentation.create') }}"
								...
								<div class="date">
                                    ...
                                    <td>
                                        <a class="btn btn-icon icon-left btn-primary"
                                            href="{{ route('seo.documentation.edit', $documentation->id) }}"><i
...
@section('end_body')
    <script>
        ...
        $(document).on('change', '.change-item-status', function(e) {
            ...
            var url = '{{ route('seo.documentations.changedocumentationStatus', ':id') }}';
