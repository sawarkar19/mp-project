@extends('layouts.seo')
@section('title', 'SEO: Document Category List')
@section('head')
        ...
        <div class="col-12 mt-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('seo.docscategories.destroys') }}" id="actionForm">
                        @csrf
                                            ...
                                            <tr id="row{{ $chan->id }}">
                                                ...
                                                <td>
                                                    <button class="btn btn-primary has-icon"
                                                        onclick="window.location.href = '{{ route('seo.docscategories.edit', $chan->id) }}'"
                                                        type="button"> <i class="fas fa-edit"></i> {{ __('Edit') }}
                                                    </button>
                                                    {{--  <button class="btn btn-success has-icon"
                                                        onclick="window.location.href = '{{ route('seo.docscategories.show', $chan->id) }}'"
...
@section('end_body')
    ...
    <script>
        ...
        function success(res) {
            setTimeout(function() {
                window.location.href = '{{ route('seo.docscategories.index') }}';
            }, 2000);
        }
