    ...
    <div class="card">
        <div class="card-body">
            <div class="card-action-filter">
                <form method="post" class="basicform_with_reload" action="{{ route('seo.pages.destroys') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex">
                                ...
                                <tr id="page_id_{{ $page->id }}">
                                    ...
                                    <td>
                                        <a class="btn btn-icon icon-left btn-primary"
                                            href="{{ route('seo.page.edit', $page->id) }}"><i class="fa fa-edit"></i></a>
