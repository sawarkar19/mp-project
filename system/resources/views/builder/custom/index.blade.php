<style>
    ...
    .custom_header_dark, .custom-footer.custom_footer_dark{
...
<div class="container shadow custom-position px-0">
    @if($offer->theme == 'light')
                ...
                <div class="d-sm-flex justify-content-between align-items-center">
                    <div class="mb-2 mb-sm-0">
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <div>
                                <div class="logo mr-2">
                                    <img src="{{ asset('assets/business/logos/'.$business->logo)}}" class="img-fluid" alt="Logo" width="50">
                                </div>
                            </div>
                             @endif
                            <div>
                    ...
                    <div class="">
                        <ul class="contact-section">
                            ...
                            <li>
                                <a href="tel:91{{ $business->call_number }}">
                            ...
                            <li>
                                <a target="_blank" href="https://wa.me/{{ $business->whatsapp_number }}">
                            ...
                            @if($business->google_map_link != '')
                                <li>
                                    <a href="{{ $business->google_map_link }}" target="_blank">
    ...
    @else
        @if($offer->show_header == 1)
        <div class="custom-header custom_header_dark" id="custom_header_dark">
            <div class="custom-header-inner">
                <div class="d-sm-flex justify-content-between align-items-center">
                    <div class="mb-2 mb-sm-0">
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <div>
                                <div class="logo mr-2">
                                    <img src="{{ asset('assets/business/logos/'.$business->logo)}}" class="img-fluid" alt="" width="50">
                                </div>
                            </div>
                            @endif
                            <div>
                    ...
                    <div class="">
                        <ul class="contact-section">
                            @if($business->call_number != '')
                                <li>
                                    <a href="tel:{{ $business->call_number }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                    </svg>
                                    </a>
    ...
    <div class="custom-image">
        <img src="{{ asset('assets/templates/custom/').'/'.$offer->image }}" class="w-100">
    </div>

    @if($offer->theme == 'light')
        @if($offer->show_footer == 1)
        <div class="custom-footer" id="custom_footer">
            <div class="custom-footer-inner">
                <div class="row align-items-center">
                    <div class="col-sm-5 text-center text-sm-left">
                        <a href="tel:{{ $business->call_number }}" class="number_link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                            </svg>
                            <span>{{ $business->call_number }}</span>
                        </a>
                    </div>
                    <div class="col-sm-7">
                        <div >
                            <ul class="social-icons mb-0">
                                ...
                                <li class="si-tab">
                                    <a href="{{ $business->facebook_link }}" class="fb" title="Facebook" id="facebook_link" target="_blank">
                                ...
                                <li class="si-tab">
                                    <a href="{{ $business->instagram_link }}" class="ig" title="Instagram" id="instagram_link" target="_blank">
                                ...
                                <li class="si-tab">
                                    <a href="{{ $business->twitter_link }}" class="tw" title="Twitter" id="twitter_link" target="_blank">
                                ...
                                <li class="si-tab">
                                    <a href="{{ $business->linkedin_link }}" class="li" title="LinkedIn" id="linkedin_link" target="_blank">
                                ...
                                <li class="si-tab">
                                    <a href="{{ $business->youtube_link }}" class="yt" title="YouTube" id="youtube_link" target="_blank">
                                ...
                                @if($business->google_review_placeid != '')
                                <li class="si-tab">
                                    <a href="https://search.google.com/local/writereview?placeid={{ $business->google_review_placeid }}" class="gr" title="Google" id="google_review_link" target="_blank">
    ...
    @else
        @if($offer->show_footer == 1)
        <div class="custom-footer custom_footer_dark" id="custom_footer_dark">
            <div class="custom-footer-inner">
                <div class="row align-items-center">
                    <div class="col-sm-5 text-center text-sm-left">
                        <a href="tel:{{ $business->call_number }}" class="number_link">
    ...
    {{-- <div>
        <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text" id="">Website URL</span>
            </div>
            <input type="text" class="form-control" value="{{ $offer->website_url }}" readonly>
            <a href="{{ $offer->website_url }}" target="_blank" class="btn btn-primary">Go to URL</a>
        </div>
    </div> --}}
