                                ...
                                <div class="row head justify-content-end align-items-center py-1">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="text-center text-md-right">
                                            <ul class="contact-section d-inline-block pl-0 mb-md-0 mt-2 OL-EDITABLE" data-tab="#_contact_section_">
                                ...
                                <div class="row">
                                    <div class="col-12 p-0">
                                        ...
                                        <div class="bannertxt py-3 py-sm-5">
                                            <h2 class="banhead1 OL-EDITABLE" data-tab="#_text_1_" id="text_input_1">{{ $template->content[0]->content }}</h1>
                                            <h1 class="banhead2 OL-EDITABLE" data-tab="#_text_2_" id="text_input_2">{{ $template->content[1]->content }}</h1>
                                            <h2 class="banhead1 OL-EDITABLE" data-tab="#_text_3_" id="text_input_3">{{ $template->content[2]->content }}</h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
