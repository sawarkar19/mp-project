                ...
                <div class="template-main" style="background-image: url({{ asset('assets/templates/'.$id.'/'.$template->bg_image)}});background-color: {{ $template->bg_color }};" data-default-img="{{ asset('assets/templates/'.$id.'/'.$template->bg_image)}}" id="tem_back">
                    <div class="inner-wrapper">
                        ...
                        <div class="position-relative">
                            {{-- CONTACT OPTION  --}}
                            <ul class="mb-0 contact-section OL-EDITABLE" data-tab="#_contact_section_">
                        ...
                        <div class="container-fluid">
                            <div class="col-md-6 mt-5 mt-sm-4">
                                <div class="OL-EDITABLE" data-tab="#_text_1_">
                                    <h2 class="h2 mb-1" id="text_input_1" style="font-weight: bold;">{{ $template->content[0]->content }}</h2>
                                </div>
                        ...
                        <div class="container-fluid">
                                ...
                                <div class="marHero mb-5">
                                    <div class="bgHero">
                                        <h2 class="h2 font-700 OL-EDITABLE"  data-tab="#_text_2_" id="text_input_2">{{ $template->content[1]->content }}</h2>
