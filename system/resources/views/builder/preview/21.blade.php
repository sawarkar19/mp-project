            ...
            <section class="template-container OL-EDITABLE OL-ACTIVE" data-tab="#_main_tab_">
                <div class="template-main" style="background-image: url({{ asset('assets/templates/'.$id.'/'.$template->bg_image)}});background-color: {{ $template->bg_color }};" data-default-img="{{ asset('assets/templates/'.$id.'/'.$template->bg_image)}}" id="tem_back">
                    <div class="inner-wrapper">
                                ...
                                <div class="temp-container">
                                    ...
                                    <div class="row d-flex align-items-center pb-md-5">
                                        ...
                                        <div class="col-md-7 pl-md-0">
                                            <div class="mt-5 mb-3 py-md-4 head_text">
                                                <h2 class="h3 text-capitalize OL-EDITABLE" data-tab="#_text_1_" id="text_input_1">{{ $template->content[0]->content }}</h2>
                                            </div>
                                            {{-- call to action button --}}
                                            @if($template->button[0]->is_hidden != 1)
                                                <div class="mb-5 text-center text-md-left call-to-action">
                            ...
                            <div class="bg-theme my-5 py-md-5">
                                <div class="container-fluid">
                                    <div class="temp-container">
                                        <div class="ub-header py-5 d-flex align-items-center">
                                            <div class="line"></div>
                                            <div class="ml-3">
                                                <h2 class="h1 text-capitalize OL-EDITABLE" data-tab="#_text_2_" id="text_input_2">{{ $template->content[1]->content }}</h2>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="busines-name mb-4">
                                                @if($only_view == 1)
                                                    <h1 class="h5 b_head mb-0" style="font-family: 'Poppins', sans-serif;">The Beauty World</h1>
                                                    <p class="mb-0">Where beauty begins</p>
                                                @else
                                                    
                                                    @if($business->website != null)
                                                    <h1 class="h5 b_head mb-0" style="font-family: 'Poppins', sans-serif;"><a href="{{$business->website}}" target="_blank" class="website_anchr">{{ $business->business_name }}</a></h1>
                                                    @else
                                                    <h1 class="h5 b_head mb-0" style="font-family: 'Poppins', sans-serif;">{{ $business->business_name }}</h1>
                                                    @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="OL-EDITABLE mb-3" data-tab="#_social_links_">
