                                ...
                                <div class="mt-5 pt-md-4">
                                    <div class="row">
                                        @if(!empty($template->gallery))
                                            <div class="col-12 col-md-6 mt-2 mt-md-0 order-2 OL-EDITABLE text-center" data-tab="#_gal_sec_1">
                                        ...
                                        @if(!empty($template->gallery))
                                            @foreach($template->gallery as $gallery)
                                                @if($loop->iteration >= 5 && $loop->iteration < 9)
                                                    <div class="col-6 col-sm-3 OL-EDITABLE">
                            ...
                            <div class="row footer p-md-5">
                                <div class="col-12 col-md-6 order-2 my-4 mt-md-0">
                                    ...
                                    <div class="busines-name">
                                        @if($only_view == 1)
                                            <h1 class="h5 mb-1">Jwellery Store</h1>
                                            <p class="mb-sm-3 small">All Type of Jwellery</p>
                                        @else
                                            ...
                                            <p class="mb-sm-3 small">{{ $business->tag_line }}</p>
                                        @endif
                                    </div>
