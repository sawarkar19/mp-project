                                    ...
                                    <div class="row align-items-center">
                                        @if(!empty($template->gallery))
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div class="columns d-inline-block OL-EDITABLE" data-tab="#_gal_sec_{{$loop->iteration}}">
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <div class="col-md-12">
                                            <div class="busines-name">
                                                @if($only_view == 1)
                                                    <h1 class="h5 b_head mb-0">Best Super Market</h1>
                                                    <p class="mb-0">Heavy Discount</p>
                                                @else
