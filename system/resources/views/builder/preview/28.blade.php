                            ...
                            <div class="tmplt-container">
                                <div class="text-center w-100">
                                    ...
                                    <div class="busines-name mb-4">
                                        @if($only_view == 1)
                                            <h1 class="h5 mb-1">Hira Lal Jwellers</h1>
                                            <p class="mb-0 ">Trusted by many</p>
                                        @else
                                    ...
                                    <div class="text-center mx-auto">
                                        ...
                                        <ul class="contact-section OL-EDITABLE" data-tab="#_contact_section_">
                                            @if($only_view == 1)
                                                ...
                                                <li><a href="#" data-toggle="modal" data-target="#LocationModal"><i class="bi bi-geo-alt"></i> Location</a></li>
                                                <li><a href=""><i class="bi bi-globe2"></i> Web</a></li>
                                                @else
                            ...
                            <div class="" style="margin-top: 25px;">
                                <div class="container">
                                    <div class="footer pt-3">
                                        ...
                                        {{-- Social Media Links --}}
                                            <div class="col-md-6 col-sm-6 col-12 text-center text-sm-left">
                                                <div class="pt-3 mb-2 mb-sm-4">
                                                        @if($only_view != 1)
                                            ...
                                            <div class="col-md-6 col-sm-6 col-12 social-number">
                                                ...
                                                <div class="float-sm-right text-center">
                                                    <div class="OL-EDITABLE" data-tab="#_social_links_">
                                                        <ul class="social-icons pt-2 mb-2 mb-sm-4">
                                                            @if($only_view == 1)
