                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-7 order-md-2">
                                    <div class="banner_image">
                                        <div class="main_image circle OL-EDITABLE" data-tab="#_main_image_">
                                            <img src="{{ asset('assets/templates/'.$id.'/'.$template->hero_image)}}" data-default-img="{{ asset('assets/templates/'.$id.'/'.$template->hero_image)}}" class="" id="tem_main_img" alt="Banner">
                                        </div>
                                    ...
                                    {{-- main banner --}}
                                        <div class="logo mt-4">
                                         ...
                                         <div class="busines-name">
                                            @if($only_view == 1)
                                                <h1 class="h5 b_head mb-0">Spa Services</h1>
                                                <p class="">Sparkles to your Shine</p>
                                            @else
                                                ...
                                                <p class="">{{ $business->tag_line }}</p>
                                            @endif        
                                        </div>
                                        <div class="mt-lg-4 py-4 head">
                                            <h2 class="h3 OL-EDITABLE" data-tab="#_text_1_" id="text_input_1">{{ $template->content[0]->content }}</h2>
                                        ...
                                        @if($template->button[0]->is_hidden != 1)
                                            <div class="mb-5 pb-4 call-to-action">
                            ...
                            <div class="second_section">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-7 d-flex flex-column justify-content-between">
                                        <div class="extra_text mb-4 mb-md-0">
                                            <div class="ub-header ex_head">
                                                <div class="OL-EDITABLE" data-tab="#_text_3_">
                                                    <h2 id="text_input_3" class="mb-3">{{ $template->content[2]->content }}</h2>
                                                </div>
