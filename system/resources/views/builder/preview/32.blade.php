                    ...
                    <div class="container-fluid ">
                        <div class="text-center py-3">
                            ...
                            <div class="busines-name mb-4">
                                @if($only_view == 1)
                                    <h1 class="h6 mb-1">Craft & Sons</h1>
                                    <p class="mb-0 small text-uppercase">Lorem ipsum dolor sit</p>
                                @else

                                    @if($business->website != null)
                                    <h1 class="h6 mb-1"><a href="{{$business->website}}" target="_blank" class="website_anchr">{{ $business->business_name }}</a></h1>
                                    @else
                                    <h1 class="h6 mb-1">{{ $business->business_name }}</h1>
                                    @endif
                        ...
                        <div class="tmplt-container text-center pt-4 pb-3">
                       ...
                       <div class="mb-4 text-center call-to-action">
