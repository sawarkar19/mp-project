                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-md-8 col-lg-9 order-md-1">
                                    <div class="busines-name">
                                        @if($only_view == 1)
                                            <h1 class="h4 mb-1">The Jewellery Store</h1>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <ul class="social-icons">
                                        ...
                                        <li class="si-tab">
                                            <a href="" class="gr" title="Google" id="google_review_link" target="_blank"><i class="bi bi-youtube gr"></i></a>
                                        </li>
                                ...
                                <div class="col-md-5">
                                    <div class="text-center tel-number text-md-right">
                                        ...
                                        @if($only_view != 1)
                                            <a href="tel:{{ $call_number }}" class="link_domain text-dark" id="website_link"><i class="bi bi-phone"></i> {{ $call_number }}</a>
                                        @else
                                            <a href="" class="link_domain text-dark" id="website_link"><i class="bi bi-phone"></i> 9123456789</a>
                                        @endif
