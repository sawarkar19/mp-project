            ...
            <div class="template-main" style="background-image: url({{ asset('assets/templates/'.$id.'/'.$template->bg_image)}});background-color: {{ $template->bg_color }};" data-default-img="{{ asset('assets/templates/'.$id.'/'.$template->bg_image)}}" id="tem_back">
                <div class="inner-wrapper">
                                    ...
                                    <div class="hero-banner">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                {{-- Logo  --}}
                                                <div class="logo_text" style="height: 100%;">
                                                      
                                                    {{-- Main Image (Hero)  --}}
                                                    <div class="">
                                                        <div class="OL-EDITABLE mb-3" data-tab="#_text_1_">
                                                            <h2 class="display-4 mb-1 head-text" id="text_input_1">{{ $template->content[0]->content }}</h2>
                                                        </div>
                                                    </div>
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <div class="img_text">
                                    <div class="float-right text">
                                        <h2 class="heroHead OL-EDITABLE" data-tab="#_text_2_" id="text_input_2">{{ $template->content[1]->content }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mt_gallery">
                                    <div>
                                        <div class="d-block d-md-flex gallery_image_div">
                                            @if(!empty($template->gallery))
                                                @foreach($template->gallery as $gallery)
                                                    <div class="columns">
                                                        <div class="product-card img_div OL-EDITABLE" data-tab="#_gal_sec_{{$loop->iteration}}">
                    ...
                    @endphp
                         ...
                         {{-- Footer --}}
                        <div class="back-foot" style="margin-top: 25px;">
                            <div class="tmplt-container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-12">
                                                <div class="text-center text-sm-left">
                                                    ...
                                                    <div class="busines-name pt-2 text-center text-sm-left">
                                                        @if($only_view == 1)
                                                            <h1 class="h4 mb-1 text-dark">Travel</h1>
                                                            <p class="mb-0 small">Lorem ipsum dolor sit</p>
                                                        @else
                                                            
                                                            @if($business->website != null)
                                                            <h1 class="h4 mb-1 text-dark"><a href="{{$business->website}}" target="_blank" class="website_anchr">{{ $business->business_name }}</a></h1>
                                                            @else
                                                            <h1 class="h4 mb-1 text-dark">{{ $business->business_name }}</h1>
                                                            @endif
                                            ...
                                            <div class="col-md-6 col-sm-6 col-12 social-number">
                                                ...
                                                <div class="text-center text-sm-right">
                                                    ...
                                                    <div class="pb-2">
                                                        ...
                                                        @else
                                                            <a href="" class="link_domain h6" id="website_link" style="font-weight: bold;"><i class="bi bi-phone"></i> 9123456789</a>
                                                        @endif
                                                    </div>
