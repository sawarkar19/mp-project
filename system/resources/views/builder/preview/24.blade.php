                                ...
                                <div class="row align-items-center py-4 py-md-5">
                                    <div class="col-md-6">
                                        ...
                                        {{-- main banner --}}
                                            ...
                                            <div class="mt-md-5 mb-md-2 py-4">
                                                ...
                                                <div class="columns">
                                                    <div class="OL-EDITABLE" data-tab="#_gal_sec_{{$loop->iteration}}">
                                                        <div class="product-card">
                                                            ...
                                                            <h5 class="text-center image_title text-capitalize" id="tem_image_title_{{ $loop->iteration }}">{{ $gallery->title }}</h5>
                                                        </div>
                                                    </div>    
                                                </div>
                                             @endforeach
                                    ...
                                    <div class="row text-center">
                                        <div class="col-md-6">
                                            <div class="busines-name mb-3">
                                                @if($only_view == 1)
                                                    <h1 class="h5 b_head mb-0">Education</h1>
                                                    <p class="mb-0">Kick start your career</p>
                                                @else
