                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 bg-white">
                                        <div class="OL-right-tab py-5">
                                            ...
                                            <div class="mb-5">
                                                <div class="text-center OL-EDITABLE" data-tab="#_text_1_">
                                                    <h2 class="display-4" id="text_input_1">{{ $template->content[0]->content }}</h2>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mb-5">
                                        <div class="footer">
                                            <div class="row align-items-center">
                                                <div class="col-sm-6 tel-number text-center text-sm-left">
