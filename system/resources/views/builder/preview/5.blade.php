                    ...
                    <div class="container-fluid ">
                        <div class="text-center py-5">
                            ...
                            <div class="busines-name mb-4">
                                @if($only_view == 1)
                                    <h1 class="h4 mb-1">The Jewellery</h1>
                                    <p class="mb-0 small text-uppercase">The Joy of Wearing Best</p>
                                @else
                            ...
                            <div class="tmplt-container mb-4">
                                <div>
                            ...
                            <div class="tmplt-container mb-5">
                            ...
                            <div class="tmplt-container">
                                <div class="footer">
                                    <div class="row align-items-center">
                                        ...
                                        {{-- Contact Number  --}}
                                        <div class="col-sm-6 tel-number text-center text-sm-right">
                                            @if($only_view != 1)
