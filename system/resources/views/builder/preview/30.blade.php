            ...
            <section class="template-container OL-EDITABLE OL-ACTIVE" data-tab="#_main_tab_">
                <div class="template-main" style="background-image: url({{ asset('assets/templates/'.$id.'/'.$template->bg_image)}});background-color: {{ $template->bg_color }};" data-default-img="{{ asset('assets/templates/'.$id.'/'.$template->bg_image)}}" id="tem_back">
                    <div class="inner-wrapper">
                            ...
                            <div class="pt-5 py-sm-5">
                                <div class="float-sm-right">
                                    ...
                                    <div class="busines-name mb-4">
                                        @if($only_view == 1)
                                            <h1 class="h5 mb-1">Hummer</h1>
                                            <p class="mb-0 small">Making your cars fast</p>
                                        @else
                        ...
                        <div class="tmplt-container p-4 mt-5">
                            <div>
                                <h2 class="headFont mb-3 OL-EDITABLE" data-tab="#_text_1_" id="text_input_1">{{ $template->content[0]->content }}</h2>
                                <hr class="hrline1">
                                ...
                                <div class="footer pt-3">
                                    <div class="container-fluid">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="pt-0 mb-0 pt-md-3 mb-md-4">
                                                    @if($only_view != 1)
                                                        <a href="tel: {{ $call_number }}" class="link_domain h5" id="website_link"><i class="bi bi-phone"></i> {{ $call_number }}</a>
                                                    @else
                                                        <a href="" class="link_domain h5" id="website_link" style="font-weight: bold;"><i class="bi bi-phone"></i> 9123456789</a>
                                                    @endif
                                            </div>
                                        </div>
