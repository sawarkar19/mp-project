                                            ...
                                            <div class="columns OL-EDITABLE" data-tab="#_gal_sec_{{$loop->iteration}}">
                                                <div class="OL-EDITABLE" data-tab="#_gal_sec_{{$loop->iteration}}">
                                                    <div class="product-card img_div">
                                                        ...
                                                        <h5 class="text-center mt-3 image_title OL-EDITABLE" id="tem_image_title_{{ $loop->iteration }}">{{ $gallery->title }}</h5>
                                                    </div>
                                                </div>
                                            </div>    
                                        @endforeach
                                    ...
                                    {{-- Business Name & Tagline  --}}
                                        <div class="col-md-6 col-sm-6">
                                            <div class="busines-name text-center text-sm-left mb-1">
                                                @if($only_view == 1)
                                                <h1 class="h5 mb-1 text-uppercase">Beauty World</h1>
                                                <p class="mb-0 small">Be gorgeous inside out </p>
                                                 @else
