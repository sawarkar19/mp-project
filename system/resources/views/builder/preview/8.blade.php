                                                ...
                                                <div class="ub-row">
                                                    <div>
                                                        ...
                                                        <div class="busines-name mb-4">
                                                            @if($only_view == 1)
                                                                <h1 class="h5 mb-0">Honda Motors</h1>
                                                                <p class="mb-0">The Joy of Wearing Best</p>
                                                            @else
                                                                
                                                                @if($business->website != null)
                                                                <h1 class="h5 mb-0"><a href="{{$business->website}}" target="_blank" class="website_anchr">{{ $business->business_name }}</a></h1>
                                                                @else
                                                    ...
                                                    <div class="ub-header">
                                                        <div class="OL-EDITABLE" data-tab="#_text_1_" >
                                                            <h2 id="text_input_1">{{ $template->content[0]->content }}</h2>
                                                        </div>
                                                    </div>
                        ...
                        <div>
                            <div class="container-fluid">
                                <div class="temp-container">
                                    ...
                                    <div class="bg-theme py-4 px-3 mb-5">
