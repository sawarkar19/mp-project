		                          		...
		                          		<div class="hero-banner">
				                            <div class="row">
					                            <div class="col-md-6 col-sm-6">
                                                    {{-- Logo  --}}
							                        <div class="d-flex justify-content-between flex-column logo_text" style="height: 100%;">
							                        	<div>
					                                        <div class="logo mb-2">
                                                            @if($only_view == 1)
                                                            ...
                                                            @if($only_view == 1)
                                                                <h1  class="h4 mb-1 text-uppercase"></h1>
                                                                <p class="mb-sm-0 small">Be gorgeous inside out </p>
                                                            @else
                                                                
                                                                @if($business->website != null)
                                                                <h1 class="h4 mb-1 text-uppercase"><a href="{{$business->website}}" target="_blank" class="website_anchr">{{ $business->business_name }}</a></h1>
                                                                @else
                                                                <h1 class="h4 mb-1 text-uppercase">{{ $business->business_name }}</h1>
                                                                @endif
                                                        ...
                                                        <div class="">
                                                            <div class="OL-EDITABLE mb-3"data-tab="#_text_1_" >
                                                                <h2 class="display-4 mb-1" id="text_input_1">{{ $template->content[0]->content }}</h2>
                                                            </div>
                                                        </div>
                            ...
                            <div class="tmplt-container">
                            	<div class="container-fluid">
                            		<div class="row img_text">
                            			<div class="col-md-6 col-sm-6 order-sm-2 mt-5 ">
                            				<div class="">
						                        <div>
											        <div class="text">
                                                        <h2 class="h1 my-3 OL-EDITABLE" data-tab="#_text_2_" id="text_input_2">{{ $template->content[1]->content }}</h2>
                                                        <div class="hrline1"></div>
                                                        <p class="mt-3 OL-EDITABLE" data-tab="#_text_3_" id="text_input_3" >{{ $template->content[2]->content }}</p>
                                                </div>
											  	</div>
						                    </div>
