                        ...
                        <div>
                            ...
                            <div class="py-2 mb-5">
                                <div class="tmplt-container">
                                    <div class="">
                                        {{-- CONTACT OPTION  --}}
                                        <ul class="mb-0 contact-section d-inline-block OL-EDITABLE" data-tab="#_contact_section_">
                                            @if($only_view == 1)
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="busines-name">
                                                    @if($only_view == 1)
                                                        <h1 class="h4 mb-1">Hair Salon</h1>
                                                        <p class="mb-sm-0 small text-uppercase">Taking care of all of your needs.</p>
                                                    @else
