                                ...
                                <div class="tmplt-container">
                                    ...
                                    <div class="mb-3">
                                        <div>
                                            ...
                                            <hr style="width: 120px;" class="border-white ml-0">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="busines-name mb-2">
                                                    @if($only_view == 1)
                                                        <h1 class="h4 mb-1">Cars Point</h1>
                                                        <p class="mb-sm-0 small text-uppercase">We're Truly Auto Motivate</p>
                                                    @else
                                            ...
                                            <div class="col-sm-6">
                                                <div class="OL-EDITABLE mb-2" data-tab="#_social_links_">
