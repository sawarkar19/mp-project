			...
			<div class="template-main" style="background-image: url({{ asset('assets/templates/'.$id.'/'.$template->bg_image)}});background-color: {{ $template->bg_color }};" data-default-img="{{ asset('assets/templates/'.$id.'/'.$template->bg_image)}}" id="tem_back">
                <div class="inner-wrapper">
                                    ...
                                    <div class="text-center">
                                        <div>
                                            ...
                                            @if($only_view == 1)
                                                ...
                                                <p class="mb-sm-0 small">Making your cars fast</p>
                                            @else
                                                @if($business->website != null)
                                        ...
                                        {{-- Main Image (Hero)  --}}
                                        <div class="OL-EDITABLE my-3 ex_head" data-tab="#_text_1_">
                    ...
                    @endphp
                       ...
                       {{-- Footer --}}
                    <div class="" style="margin-top: 10px;background: #be7003;">
                        <div class="tmplt-container">
                            <div class="footer pt-3">
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-12">
                                        <div class="pt-3 mb-4 text-center text-md-left">
                                            @if($only_view != 1)
                                                <a href="tel: {{ $call_number }}" class="link_domain h6" id="website_link"><i class="bi bi-phone"></i> {{ $call_number }}</a>
                                            @else
                                                <a href="" class="link_domain h6" id="website_link"><i class="bi bi-phone"></i> 9123456789</a>
                                            @endif
                                        </div>
                                    </div>
