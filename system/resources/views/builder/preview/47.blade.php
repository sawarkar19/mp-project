            ...
            <section class="template-container OL-EDITABLE OL-ACTIVE" data-tab="#_main_tab_">
                <div class="template-main" style="background-image: url({{ asset('assets/templates/'.$id.'/'.$template->bg_image)}});background-color: {{ $template->bg_color }};" data-default-img="{{ asset('assets/templates/'.$id.'/'.$template->bg_image)}}" id="tem_back">
                    <div class="inner-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="banImg text-center">
                                            <img src="{{ asset('assets/templates/'.$id.'/banner-sparkle.png')}}" class="img-fluid" alt="Banner">
                                        </div>
                                        ...
                                        <div class="text-center marText">
                                            <h5 class="banHead1 text-uppercase OL-EDITABLE" data-tab="#_text_1_" id="text_input_1">{{ $template->content[0]->content }}</h5>
                                            <h5 class="banHead2 OL-EDITABLE" data-tab="#_text_2_" id="text_input_2">{{ $template->content[1]->content }}</h5>
                                            <h5 class="banHead3 text-uppercase OL-EDITABLE" data-tab="#_text_3_" id="text_input_3">{{ $template->content[2]->content }}</h5>
                                        </div>
                                        <div class="mb-3 text-center">
                                            <img src="{{ asset('assets/templates/'.$id.'/banner-line.png')}}" class="img-fluid" alt="Banner">
                                            <div class="OL-EDITABLE" data-tab="#_text_4_">
                                                <h2 class="h3" id="text_input_4">{{ $template->content[3]->content }}</h2>
                                            </div>
                                            <img src="{{ asset('assets/templates/'.$id.'/banner-line.png')}}" class="img-fluid" alt="Banner">
                                            <p class="OL-EDITABLE" data-tab="#_text_5_" id="text_input_5">{{ $template->content[4]->content }}</p>
                                        </div>
                                        <div class="mb-2 text-center">
                                            <img src="{{ asset('assets/templates/'.$id.'/banner-diyas.png')}}" class="img-fluid" alt="Banner">
                                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="temp-container">
                                ...
                                <div class="text-center mt-5 mb-3">
                                    <h2 class="h3 OL-EDITABLE" data-tab="#_text_6_" id="text_input_6">{{ $template->content[5]->content }}</h2>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div class="columns OL-EDITABLE" data-tab="#_gal_sec_{{$loop->iteration}}">
                                                    ...
                                                    <div class="position-relative text-center">
                                                        <div class="title-bar">
                                                            <p class="mt-3 mb-2 h6" id="tem_image_title_{{ $loop->iteration }}">{{ $gallery->title }}</p>
                                                        </div>
                                                    </div>
                        ...
                        <div class="bg-red p-3 text-center">
                            <div class="Offer_bg p-5">
                                <span class="offer_borderImg"><img src="{{ asset('assets/templates/'.$id.'/offer-Img.png')}}" class="img-fluid" alt="Offer Banner"></span>
                                <span class="offer_borderImg"><img src="{{ asset('assets/templates/'.$id.'/offer-Img.png')}}" class="img-fluid" alt="Offer Banner"></span>
                                <span class="offer_borderImg"><img src="{{ asset('assets/templates/'.$id.'/offer-Img.png')}}" class="img-fluid" alt="Offer Banner"></span>
                                <span class="offer_borderImg"><img src="{{ asset('assets/templates/'.$id.'/offer-Img.png')}}" class="img-fluid" alt="Offer Banner"></span>
                                <div class="my-5">
                                    <span class="offer_img">
                                        <img src="{{ asset('assets/templates/'.$id.'/offerDiya.png')}}" class="img-fluid" alt="Offer Banner">
                                    </span>
                                    <span class="offer_txt mx-0 mx-md-3 OL-EDITABLE" data-tab="#_text_8_" id="text_input_8">{{ $template->content[7]->content }}</span>
                                    <span class="offer_img">
                                        <img src="{{ asset('assets/templates/'.$id.'/offerDiya.png')}}" class="img-fluid" alt="Offer Banner">
                                    </span>
                                </div>
                                <h2 class="h2 OL-EDITABLE" data-tab="#_text_9_" id="text_input_9">{{ $template->content[8]->content }}</h2>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    <div class="busines-name text-center text-sm-right">
                                        @if($only_view == 1)
                                            <h1 class="h5">The Jewellery Store</h1>
                                            <p class="mb-0">The Joy of Wearing Best</p>
                                        @else
                                            @if($business->website != null)
                                            <h1 class="h5"><a href="{{$business->website}}" target="_blank" class="website_anchr">{{ $business->business_name }}</a></h1>
                                            @else
                                            <h1 class="h5">{{ $business->business_name }}</h1>
                                            @endif
