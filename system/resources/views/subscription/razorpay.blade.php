...
<!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M3G7JRD"
...
@if(url('/payment-with/razorpay') != URL::current())
<form action="{{ url('/business/razorpay/status')}}" method="POST" hidden>
@else
...
<input type="hidden" value="Logic Innovates" id="name">
