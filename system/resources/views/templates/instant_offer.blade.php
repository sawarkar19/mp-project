              ...
              <div class="">
                ...
                {{-- Instant Tasks List --}}
                  <div class="task_list">
                    ...
                    @php
                        if((!in_array($task_ids['fb_page_url'], $redeemedTasks) && in_array($task_ids['fb_page_url'], $completedTasks)) || !in_array($task_ids['fb_page_url'], $completedTasks)){
                            $fb_page_url_hide = '';
                        }else{
                            $fb_page_url_hide = 'hide_task';
                        }

                    @endphp 

                    <div class="ins_task border-bottom fb {{ $fb_page_url_hide }}">

                        {{-- <a target="_blank" href="{{ $tasks['fb_page_url'] }}" id="fb_page_url" class="task_click"> --}} {{-- CLick Event --}}
                        <a href="fb://page/{{ $tasks['fb_page_url'] }}" id="fb_page_url" class="task_click">
                    ...
                    @php
                        if((!in_array($task_ids['fb_post_url'], $redeemedTasks) && in_array($task_ids['fb_post_url'], $completedTasks)) || !in_array($task_ids['fb_post_url'], $completedTasks)){
                            $fb_post_url_hide = '';
                        }else{
                            $fb_post_url_hide = 'hide_task';
                        }

                    @endphp

                    <div class="ins_task border-bottom fb {{ $fb_post_url_hide }}">

                        {{-- <a target="_blank" href="{{ $tasks['fb_post_url'] }}" id="fb_post_url" class="task_click"> --}} {{-- CLick Event --}}
                        <a href="fb://facewebmodal/f?href={{ $tasks['fb_post_url'] }}" id="fb_post_url" class="task_click "> {{-- CLick Event --}}
                    ...
                    @php
                        if((!in_array($task_ids['tw_username'], $redeemedTasks) && in_array($task_ids['tw_username'], $completedTasks)) || !in_array($task_ids['tw_username'], $completedTasks)){
                            $tw_username_hide = '';
                        }else{
                            $tw_username_hide = 'hide_task';
                        }

                    @endphp

                    <div class="ins_task border-bottom tw {{ $tw_username_hide }}" title="Task Completed" data-bs-toggle="tooltip">
                    ...
                    @php
                        if((!in_array($task_ids['tw_tweet_like'], $redeemedTasks) && in_array($task_ids['tw_tweet_like'], $completedTasks)) || !in_array($task_ids['tw_tweet_like'], $completedTasks)){
                            $tw_tweet_like_hide = '';
                        }else{
                            $tw_tweet_like_hide = 'hide_task';
                        }

                    @endphp

                    <div class="ins_task border-bottom tw {{ $tw_tweet_like_hide }}" title="Task Completed" data-bs-toggle="tooltip">
                    ...
                    @php
                        if((!in_array($task_ids['insta_profile_url'], $redeemedTasks) && in_array($task_ids['insta_profile_url'], $completedTasks)) || !in_array($task_ids['insta_profile_url'], $completedTasks)){
                            $insta_profile_url_hide = '';
                        }else{
                            $insta_profile_url_hide = 'hide_task';
                        }

                    @endphp

                    <!-- single task -->
                      <div class="ins_task border-bottom ig {{ $insta_profile_url_hide }}">
                        {{-- <a target="_blank" href="{{ $tasks['insta_profile_url'] }}" id="insta_profile_url" onclick="" class="task_click"> --}}

                        <a href="instagram://user?username={{ $tasks['insta_profile_url'] }}" id="insta_profile_url" class="task_click">
                    ...
                    @php
                        if((!in_array($task_ids['insta_post_url'], $redeemedTasks) && in_array($task_ids['insta_post_url'], $completedTasks)) || !in_array($task_ids['insta_post_url'], $completedTasks)){
                            $insta_post_url_hide = '';
                        }else{
                            $insta_post_url_hide = 'hide_task';
                        }

                    @endphp

                        <div class="ins_task border-bottom ig {{ $insta_post_url_hide }}">
                        ...
                        @php
                            if((!in_array($task_ids['yt_channel_url'], $redeemedTasks) && in_array($task_ids['yt_channel_url'], $completedTasks)) || !in_array($task_ids['yt_channel_url'], $completedTasks)){
                                $yt_channel_url_hide = '';
                            }else{
                                $yt_channel_url_hide = 'hide_task';
                            }

                        @endphp

                        <div class="ins_task border-bottom yt {{ $yt_channel_url_hide }}">
                        ...
                        @php
                            if((!in_array($task_ids['yt_comment_url'], $redeemedTasks) && in_array($task_ids['yt_comment_url'], $completedTasks)) || !in_array($task_ids['yt_comment_url'], $completedTasks)){
                                $yt_comment_url_hide = '';
                            }else{
                                $yt_comment_url_hide = 'hide_task';
                            }

                        @endphp

                        <div class="ins_task border-bottom yt {{ $yt_comment_url_hide }}f">
                        ...
                        @php
                            if((!in_array($task_ids['yt_like_url'], $redeemedTasks) && in_array($task_ids['yt_like_url'], $completedTasks)) || !in_array($task_ids['yt_like_url'], $completedTasks)){
                                $yt_like_url_hide = '';
                            }else{
                                $yt_like_url_hide = 'hide_task';
                            }

                        @endphp

                        <div class="ins_task border-bottom yt {{ $yt_like_url_hide }}">
                        ...
                        @php
                            if((!in_array($task_ids['li_company_url'], $redeemedTasks) && in_array($task_ids['li_company_url'], $completedTasks)) || !in_array($task_ids['li_company_url'], $completedTasks)){
                                $li_company_url_hide = '';
                            }else{
                                $li_company_url_hide = 'hide_task';
                            }

                        @endphp

                        <div class="ins_task border-bottom li {{ $li_company_url_hide }}">
                        ...
                        @php
                            if((!in_array($task_ids['google_link'], $redeemedTasks) && in_array($task_ids['google_link'], $completedTasks)) || !in_array($task_ids['google_link'], $completedTasks)){
                                $google_link_hide = '';
                            }else{
                                $google_link_hide = 'hide_task';
                            }

                        @endphp

                        <div class="ins_task border-bottom {{ $google_link_hide }}">
                        ...
                        @php
                            if((!in_array($task_ids['visit_page_url'], $redeemedTasks) && in_array($task_ids['visit_page_url'], $completedTasks)) || !in_array($task_ids['visit_page_url'], $completedTasks)){
                                $visit_page_url_hide = '';
                            }else{
                                $visit_page_url_hide = 'hide_task';
                            }

                        @endphp

                        <div class="ins_task border-bottom {{ $visit_page_url_hide }}">
