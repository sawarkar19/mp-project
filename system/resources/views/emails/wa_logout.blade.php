...
<table class="OL_MAILER" align="center" cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#f3f6ff">
    ...
    <tr>
        <td style="padding: 20px;font-family: 'Poppins', sans-serif;">
            <table class="ol_wrapper" cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#ffffff" style="max-width:650px; margin: auto;">
                <tr>
                ...
                <tr>
                    <td style="text-align: center;padding: 10px 10px;">
                        <a href="{{url('business/settings?wa=true')}}"><img src="{{ asset('assets/emails/images/wa-disconnected.png') }}" style="width: 100%;max-width: 400px;" alt=""></a>
                    </td>
                </tr>
                <tr>
                    <td class="wa-logout" align="center">
                        {{-- <p>{{ $data['message'] }}</p> --}}
                        {{-- <h2 style="color:red;font-weight: bold;">Alert! Kindly pay attention.</h2> --}}
                        <p>{!!  $data['message'] !!}</p>
                        
                        <p style="margin-top: 20px;"><a href="{{url('/business/settings?wa=true')}}" style="padding: 7px 15px; background:#00249c;color:#FFFFFF;border:0px;border-radius:6px;text-decoration:none;" >Reconnect Now</a></p>
                    </td>
                </tr>
                ...
                <tr>
                    <td >
                        <table cellpadding="0px" cellspacing="0px" style="width: 100%;margin-bottom:15px;">
                            <tr>
                                <td style="padding: 0 0 10px 0;border-bottom: 1px dashed rgba(0,0,0,0.2);">
                                    <h4 style="font-weight: 400;margin-bottom: 0px;">
                                        <span style="color: rgb(207, 36, 24);line-height:1.8">If you have any query! </span> Feel free to connect us. <br>We are available from Monday to Friday between 10 AM to 7 PM
                                    </h4>
                                </td>
                            </tr>
                            <tr>
