                    ...
                    <tr>
                        <td style="padding: 15px;" align="center">
                            ...
                            <div style="padding: 10px;">
                                <a href="{{ route('forgotPassword', 'token='.$data['token']) }}" target="_blank" style="display:inline-block;padding:.5rem 1rem;border: 0px;background-color: #00249c;color:#FFF;text-decoration: none;border-radius: 6px;font-weight: bold;margin-bottom: 10px;">Create Password</a>
