            ...
            <table class="ol_wrapper" cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#ffffff" style="max-width:650px; margin: auto;">
                ...
                <tr>
                    <td class="wa-logout" align="center">
                        ...
                        <p style="margin-top: 20px;"><a href="{{url('../business/channel/4/api')}}" style="padding: 7px 15px; background:#00249c;color:#FFFFFF;border:0px;border-radius:6px;text-decoration:none;" >Messaging API</a></p>
                    </td>
                </tr>
