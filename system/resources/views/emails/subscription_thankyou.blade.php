                ...
                <table class="ol_wrapper" cellpadding="0px" cellspacing="0px">
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <a href="{{ route('business.planHistory') }}"><img src="{{ asset('assets/emails/images/check-ok.gif') }}" style="width: 100%;max-width: 120px;" alt=""></a>
                        </td>
                    </tr>

                    <tr>
                        <td style="text-align: center;padding-bottom: 20px;">
                            <h2 style="color: #00d34d;font-weight: 300;"><span style="font-weight: bold;">Payment Successful!</span></h2>
                            {{-- <p style="font-weight: bold;">Dear {{ $data['name'] }}, </p> --}}
                            {{-- <p>Congratulations &#128522;, you have successfully subscribed to MouthPublicity.io <span style="font-weight:400;">{{ $data['plan_name'] }}</span>.</p> --}}
                            <p>{!!  $content !!}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="ol_receipt">
                            <table cellpadding="0px" cellspacing="0px" style="width: 100%;">
                                <tr>
                                    <td style="border-bottom: 1px dashed rgba(0,0,0,0.2);">
                                        <!-- <p style="font-weight: 400;margin-bottom: 5px;">TXN ID: <span style="font-weight: bold;">BS894537438OL578</span> </p> -->
                                        <p>For your reference, we have shared the payment details with you. You can view the invoice and check your billing details here!</p>
                                        <p style="color:rgb(126, 126, 126); font-weight: 400; font-size: 12px;">{{ \Carbon\Carbon::parse($data['plan_date'])->format('g:i A') }}, {{ \Carbon\Carbon::parse($data['plan_date'])->format('d M, Y') }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top: 10px;">
                                        <table cellpadding="0px" cellspacing="0px" style="width: 100%;">
                                            <tr>
                                                <td>
                                                    <h3 style="margin-bottom: 5px;"><b>{{ $data['plan_name'] }} Plan</b></h3>
                                                </td>
                                                <td width="15"></td>
                                                <td align="right" style="min-width: 70px;">
                                                    <p style="font-weight: 400;">&#8377; <span>{{ round($data['plan_without_gst'],2) }}</span></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td width="15"></td>
                                                <td align="right" style="min-width: 70px;">
                                                    <p style="font-weight: 400;">+ &#8377; <span>{{ round($data['plan_gst'],2) }}</span></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td width="15"></td>
                                                <td align="right" style="min-width: 70px;">
                                                    <span style="font-size:18px;font-weight: bold;color: seagreen;">&#8377; <span>{{ $data['plan_price'] }}</span></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
