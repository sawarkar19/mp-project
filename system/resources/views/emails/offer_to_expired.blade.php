                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#ffffff"
                    ...
                    <tr>
                        <td style="text-align: center;padding: 30px 0;">
                            <a href="{{ route('business.designOffer') }}"><img src="{{ asset('assets/emails/images/please-schedule-offer.png') }}"
                                style="width: 100%;max-width: 380px;" alt=""></a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px;" align="center">
                            {{-- <h2 style="margin: 0 0 10px 0;font-weight: 300;">We want to <span
                                    style="font-weight:900;color:#00249c;">be with you again!</span></h2> --}}
                            <p style="font-weight: bold;">{!!  $data['message'] !!}</p>
                            <div style="padding: 10px;">
                                <a href="{{ route('business.designOffer') }}" style="display:inline-block;padding:.4rem 1.4rem;border: 0px;background-color: #00249c;color:#FFF;text-decoration: none;border-radius: 40px;font-weight: bold;margin-bottom: 10px;font-size: 13px;">Design Offer</a>
                            </div>
                        </td>
                    </tr>
