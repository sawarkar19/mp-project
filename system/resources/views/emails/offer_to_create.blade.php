                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#ffffff"
                    ...
                    <tr>
                        <td style="text-align: center;padding: 30px 0;">
                            <a href="{{ route('business.designOffer') }}"><img src="{{ asset('assets/emails/images/create-offer.png') }}"
                        ...
                        <td style="padding: 15px;" align="center">
                            ...
                            <div style="padding: 10px;">
                                <a href="{{ route('business.designOffer') }}"
                                    style="display:inline-block;padding:.4rem 1.4rem;border: 0px;background-color: #00249c;color:#FFF;text-decoration: none;border-radius: 40px;font-weight: bold;margin-bottom: 10px;font-size: 13px;">Create an
                                    Offer</a>
                            </div>
                        </td>
                    </tr>
