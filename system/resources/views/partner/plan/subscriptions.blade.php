...
@section('description',
    'Upgrade to MouthPublicity.io and Convert your customers to mouth publicity marketing team. Get it
        ...
        <div class="container">
            <div class="text-center py-5">
                <div class="pricing-details">
                    ...
                    <p class="mx-auto mb-0" style="max-width:780px;">Start using MouthPublicity.io with full potential and make
                        your business mouth publicity remarkable. Simply recharge with minimum price of Rs.100 to get full
                        access. Pay as you go with product usage.</p>
                </div>
                ...
                <div class="mt-5 mx-auto" style="max-width: 800px;">
                    <div class="card border-0 p-sm-5 px-3 py-4 bg-light_"
                        ...
                        <form action="{{ route('business.partner.updatePriceToSession') }}" method="POST" enctype="multipart/form-data" id="paymentForm">
                            ...
                            <div class="text-center mt-4 mt-md-5">
                                <button type="submit" class="btn btn-primary-ol btn-lg basicbtn" id="recharge_now">Recharge Now</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            $("#recharge_now").click(function() {
                ...
                if (amount >= 100) {
                    ...
                    {{--  window.location.href =
                        "{{ url('business/partner/make-payment/' . $plans->id . '?token=' . $paymentTokenId) }}";  --}}
