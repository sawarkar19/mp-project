                    ...
                    <div class="thankYou-inner">
                        ...
                        <div class="thankYou-content text-center mx-auto flex-fill"> 
                            <div class="">
                                ...
                                <h1 class="font-800">Recharge Successful</h1>
                                <h4> Congratulations!Your recharge is complete, and your account has been successfully credited. </h4>
                                <h6> Now you can access mouthpublicity.io on full extent and  make the most of your experience.</h6>
                            </div>
                            <div class="thankYou-content--button my-3 my-md-5 mx-auto">
                                <a href="{{ route('business.dashboard') }}" class="btn px-sm-5 px-4 py-2 btn-primary-ol">Use Pro Features Now </a>
                            </div>
