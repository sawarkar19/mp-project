                    ...
                    <div class="thankYou-inner">
                        ...
                        <div class="thankYou-content text-center flex-fill mx-auto"> 
                            <div class="">
                                ...
                                <h3 class="mb-2"><b>Thank you</b> for contacting us!</h3>
                                <h6> Thank you for reaching out to MouthPublicity.io! we look forward to connecting with you soon. In the meantime, feel free to explore our website and learn more about mouth publicity.</h6>
                                
                            </div>
                            <div class="thankYou-content--button my-3 my-md-5 mx-auto">
                                <a href="{{url('/')}}" class="btn px-sm-5 px-4 py-2 btn-primary-ol">Go to Home Page</a>
                            </div>
