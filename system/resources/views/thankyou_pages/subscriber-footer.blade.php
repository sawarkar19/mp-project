            ...
            <div class="py-2 thankYou-main">
                <div class="container">
                    <div class="thankYou-inner">
                        ...
                        <div class="thankYou-content text-center mx-auto flex-fill"> 
                            <div class="">
                                <div class="thankYou-content--icon mb-2">
                                    <i class="bi bi-patch-check text-success"></i>
                                </div>
                                <h3 class="mb-2"> <b>Confirmed!</b> You’re on the newsletter list!</h3>
                                <h6> Thank you so much for subscribing to our newsletter! We're excited to keep you updated on the latest updates, and insights for MouthPublicity.io</h6>
                            </div>
                            <div class="thankYou-content--button my-3 my-md-5 mx-auto">
                                <a href="{{url('/')}}" class="btn px-sm-5 px-4 py-2 btn-primary-ol">Back to Home</a>
                            </div>
                            <p>You will be automatically redirected in <span id="redirect-timmer"> 6</span> seconds.
                            </p>
