            ...
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="card mb-0 h-100">
                    <div class="card-header">
                        ...
                        <a href="{{route('support.exportUsers')}}" class="export btn btn-success btn-lg px-4 mx-1">Export Users</a>
                    </div>
                                                    ...
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon"
                                                                href="{{ route('support.userTransaction', encrypt($allUser->id)) }}"><i
                                                                    class="far fa-eye"></i>{{ __('View Transaction') }}
                                                            </a>
                                                            <a class="dropdown-item has-icon"
                                                                href="{{ route('support.userReport', encrypt($allUser->id)) }}"><i
