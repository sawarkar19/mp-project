...
@section('title', 'Reports: Support Panel')
@section('head')
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $("#subscription_list_data_table").DataTable({
            ...
            ajax: {
                'url': "{{ url('support/get-subscriptions') }}",
                'type': 'GET',
                'data': function (d) {
                    d._token = "{{ csrf_token() }}";
                    d.id = "{{ $id }}"
        ...
        $("#deduction_list_data_table").DataTable({
            ...
            ajax: {
                'url': "{{ url('support/get-deductions') }}",
                'type': 'GET',
                'data': function (d) {
                    d._token = "{{ csrf_token() }}";
                    d.id = "{{ $id }}"
        ...
        $("#social_impact_data_table").DataTable({
            ...
            ajax: {
                'url': "{{ url('support/get-social-impact') }}",
                'type': 'GET',
                'data': function (d) {
                    d._token = "{{ csrf_token() }}";
                    d.id = "{{ $id }}"
