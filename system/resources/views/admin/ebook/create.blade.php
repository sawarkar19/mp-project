...
@section('title', 'Admin: Ebooks')
@section('head')
<link href="{{ asset('assets/css/select2.min.css') }}" rel="stylesheet" />

@include('layouts.partials.headersection',['title'=>'Add New Ebook'])
<style>
  #error{color:#ff0000;}
  #success{color:green;}
</style>
...
<div class="row">
	<div class="col-lg-9">      
		<div class="card">
			<div class="card-body">
				<form id="ebookform" method="post" action="{{ route('admin.ebook.store') }}" enctype="multipart/form-data">
					@csrf
