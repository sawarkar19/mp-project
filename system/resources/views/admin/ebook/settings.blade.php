...
@section('head')
@include('layouts.partials.headersection', ['title'=>'Ebooks Settings'] )
@endsection
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                    <a href="#EbooksSidebarCard" class="nav-link" id="BS_" data-toggle="tab" role="tab" aria-controls="EbooksSidebarCard" aria-selected="false">Sidebar</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="tab-content no-padding">
                ...
                <div class="tab-pane fade show active" id="GenralSidebarCard">
                    <div class="card">
                        ...
                        <form id="setting-form1" method="post" action="{{ route('admin.ebooks.updateSettings1') }}">
                            @csrf
                            <div class="card-header">
                ...
                {{-- BLOG SETTINGS  --}}
                <div class="tab-pane fade" id="EbooksSidebarCard">
                    <div class="card">
                        <form id="setting-form2" method="post" action="{{ route('admin.ebooks.updateSettings2') }}">
                            @csrf
                            <div class="card-header">
                                <h4>Ebooks Sidebar</h4>
                            </div>
                            <div class="card-body">
