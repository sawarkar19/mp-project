                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <input class="form-control" type="hidden" name="slug">
                                    <input class="form-control" type="hidden" name="ordering">
                                </div>
                                ...
                                <div class="form-group">
                                    <button class="btn btn-primary basicbtn" id="submit" type="submit">{{ __('Save') }}</button>
                                </div>
                            </div>
