<script>
    ...
    $(document).on('click', '#buy_d2c_post_add', function(){

        var qty = $('#buy_d2c_post_qty').val();
        var d2c_post_counts = '{{ $d2c_post_counts }}';
        var total_qty = 4 - parseInt(d2c_post_counts);
        
        if(qty == total_qty){
            return false;
        }
        qty = parseInt(qty) + 1;
        $('#buy_d2c_post_qty').val(qty);

        var constant_price = qty * $("#buy_constant_price_d2c_post").val();
        $('#buy_sale_price_d2c_post').text(constant_price);
    ...
    $(document).on('click', '#buy_d2c_post_minus', function(){
...
<script>
    ...
    function calculate_renew_total(){
        var total = 0;
        ...
        if($('#renew_input_employee_account').is(':checked')) {
            total = total + parseInt($('#renew_sale_price_employee_account').text());
        }
