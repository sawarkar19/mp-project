...
@section('title', 'Admin: Make Payments')
@section('head')
				...
				@else
					...
					<form role="form" method="post" action="{{ url($url.'/'.$planDetails['plan_id']) }}" id="paymentForm">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" name="name" value="{{ $user->name }}" class="form-control" style="height: 40px;" id="name" readonly="">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" name="email" value="{{ $user->email }}" class="form-control" style="height: 40px;" id="email" readonly="">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="number" name="phone" value="{{ $user->mobile }}" class="form-control" style="height: 40px;" id="phone" readonly="">
							</div>
						</div>
