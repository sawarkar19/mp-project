        ...
        <div class="invoice">
          ...
          <div class="row">
            <div class="col-6 text-md-left">
                <a href="{{ route('admin.customer.viewInvoice', $transaction->id) }}"
                    class="btn btn-primary btn-icon icon-left"><i class="fas fa-eye"></i> View Invoice</a>
            </div>
            <div class="col-6 text-md-right">
                <a href="{{ route('admin.customer.downloadInvoice', $transaction->id) }}"
                    class="btn btn-primary btn-icon icon-left"><i class="fas fa-download"></i> Download Invoice</a>
            </div>
        </div>
