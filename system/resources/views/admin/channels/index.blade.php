...
@section('title', 'Admin: Channels List')
@section('head')
    @include('layouts.partials.headersection', ['title' => 'Channels List'])
@endsection
@section('content')
    <div class="row">
        <div class="col-12 mt-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.channels.destroys') }}" id="actionForm">
                        @csrf
                                            ...
                                            <tr id="row{{ $chan->id }}">
                                                ...
                                                <td>
                                                    <button class="btn btn-primary has-icon"
                                                        onclick="window.location.href = '{{ route('admin.channels.edit', $chan->id) }}'"
                                                        type="button"> <i class="fas fa-edit"></i> {{ __('Edit') }}
                                                    </button>
                                                    <button class="btn btn-success has-icon"
                                                        onclick="window.location.href = '{{ route('admin.channels.show', $chan->id) }}'"
                    ...
                    {{ $channels->appends($request->all())->links('vendor.pagination.bootstrap-4') }}
                </div>
            </div>
        </div>
    </div>
