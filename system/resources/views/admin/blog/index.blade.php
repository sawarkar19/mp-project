				...
				<table class="table">
					...
					<tbody>
						...
						<tr id="blog_id_{{ $blog->id }}">
							...
							<td>
								<a class="btn btn-icon icon-left btn-primary" href="{{ route('admin.blog.edit',$blog->id) }}" ><i class="fa fa-edit"></i></a>
	...
	<script>
		...
		$(document).on('click', '.delete-item', function(e){
		    ...
		    if (confirmation) {
				...
				var url = '{{ route("admin.blogs.destroyBlog", ":id") }}';
		...
		$(document).on('change', '.change-item-status', function(e){
			...
			var url = '{{ route("admin.blogs.changeBlogStatus", ":id") }}';
        	url = url.replace(':id', blog_id);
