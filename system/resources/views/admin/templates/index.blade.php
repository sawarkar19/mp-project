...
@section('title', 'Admin: Templates List')
@section('head')
...
<div class="row">
    <div class="col-12 mt-2">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-8"> <a href="{{ route('admin.templates.index') }}"
                            class="mr-2 btn btn-outline-primary @if($status===" all ") active @endif">{{ __('All') }}
                            ({{ $all }})</a>
                        <a href="{{ route('admin.templates.index','status=1') }}"
                            class="mr-2 btn btn-outline-success @if($status==1) active @endif">{{ __('Active') }}
                            ({{ $actives }})</a>
                        <a href="{{ route('admin.templates.index','status=0') }}"
                ...
                <form method="post" action="{{ route('admin.templates.destroys') }}" id="actionForm">
                    @csrf
                                ...
                                <tr id="row{{ $temp->id }}">
                                    ...
                                    <td>
                                        <button class="btn btn-primary has-icon"
                                            onclick="window.location.href = '{{ route('admin.templates.edit',$temp->id) }}'"
