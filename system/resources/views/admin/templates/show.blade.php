            ...
            <div class="row mt-sm-4">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="col-sm-4 text-left">
                            <a href="{{ route('admin.contents.create', ['id' => $templates->id]) }}"
                                        ...
                                        <tbody>
                                            @foreach ($contents as $index => $cont)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.contents.edit', $cont->id) }}"
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="col-sm-4 text-left">
                            <a href="{{ route('admin.galleryimages.create', ['id' => $templates->id]) }}"
                                        ...
                                        <tbody>
                                            @foreach ($gallery_imgs as $index => $gal)
                                                <tr>
                                                    ...
                                                    {{-- <td>{{ $gal->tag_1 }}</td> --}}
                                                    <td>
                                                        <a href="{{ route('admin.galleryimages.edit', $gal->id) }}"
                                                            class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
                                                        </a>
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="col-sm-4 text-left">
                            <a href="{{ route('admin.templatebuttons.create', ['id' => $templates->id]) }}"
                                        ...
                                        <tbody>
                                            @foreach ($templateButtons as $index => $button)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.templatebuttons.edit', $button->id) }}"
                                                            class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
                                                        </a>
        ...
        $(document).on('click', '.delete-item1', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ url('admin/content/destroy-page') }}' + '/' + template_content_id,
                        data: {
        ...
        $(document).on('click', '.delete-item2', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ url('admin/galleryimage/destroy-page') }}' + '/' +
                            gallery_image_id,
                        data: {
        ...
        $(document).on('click', '.delete-item', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ url('admin/templatebutton/destroy-page') }}' + '/' +
                            template_button_id,
                        data: {
