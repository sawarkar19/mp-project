            ...
            <div class="tab-content no-padding">
                ...
                <div class="tab-pane fade show active" id="GenralSidebarCard">
                    <div class="card">
                        ...
                        <form id="setting-form1" method="post" action="{{ route('admin.articles.updateSettings1') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-header">
                ...
                <div class="tab-pane fade" id="ArticlesSidebarCard">
                    <div class="card">
                        <form id="setting-form2" method="post" action="{{ route('admin.articles.updateSettings2') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-header">
                ...
                <div class="tab-pane fade" id="SeoSidebarCard">
                    <div class="card">
                        {{-- <form id="setting-form"> --}}
                        <form id="setting-form3" method="post" action="{{ route('admin.articles.updateSettings3') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-header">
                                <h4>SEO Settings</h4>
                            </div>
