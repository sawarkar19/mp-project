...
@section('title', 'Admin: Article List')
@section('head')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-action-filter">
                <form method="post" class="basicform_with_reload" action="{{ route('admin.articles.destroys') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex">
                                ...
                                <tr id="article_id_{{ $article->id }}">
                                    ...
                                    <td>
                                        <a class="btn btn-icon icon-left btn-primary"
                                            href="{{ route('admin.article.edit', $article->id) }}"><i
...
@section('end_body')
    <script>
        ...
        $(document).on('change', '.change-item-status', function(e) {
            ...
            var url = '{{ route('admin.articles.changeArticleStatus', ':id') }}';
