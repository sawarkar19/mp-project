...
@section('title', 'Admin: Menu Details')
@section('head')
@include('layouts.partials.headersection',['title'=>'Menu Details'])
@endsection
@section('start_body')
						...
						<form id="frmEdit" class="form-horizontal">
							<div class="custom-form">
								<div class="form-group">
									<label for="text">{{ __('Menu Title') }}</label>
									<div class="input-group">
										<input type="text" class="form-control item-menu" name="text" id="text" placeholder="Menu Title" autocomplete="off">
