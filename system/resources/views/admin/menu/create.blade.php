	...
	<div class="col-lg-4">      
		<div class="card">
			<div class="card-body">
				...
				<form id="basicform" method="post" action="{{ route('admin.menu.store') }}" class="">
					@csrf
							...
							<table class="table text-center category">
								<thead>
									<tr>
										...
										<th class="am-title">{{ __('Customise') }}</th>
								...
								<tbody>
									...
									<td><a href="{{ route('admin.menu.show',$menu->id) }}"><i class="fas fa-arrows-alt"></i> {{ __('Customise') }}</a></td>
