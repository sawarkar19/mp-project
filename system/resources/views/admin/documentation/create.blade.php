...
@section('head')
    ...
    @include('layouts.partials.headersection', ['title' => 'Add New Documentation'])
    <style>
        #error {
            color: #ff0000;
        }
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                <div class="card-body">
                    <form id="documentationform" method="post" action="{{ route('admin.documentation.store') }}"
                        ...
                        <div class="custom-form pt-20">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Title" name="title" class="form-control nicEdit-main"
                                    id="name">
                            </div>
                            ...
                            {{--  <div class="form-group">
                                ...
                                <input type="file" placeholder="Title" name="documentation_banner" class="form-control"
                                    id="image">
                            </div>  --}}
                            ...
                            {{--  <div class="form-group">
                                ...
                                <input type="text" placeholder="Meta Keyword" name="meta_keyword" class="form-control"
                                    id="meta_keyword">
                            </div>  --}}
            ...
            <div class="single-area">
                ...
                {{--  <div class="card sub">
                    <div class="card-body">
                        ...
                        <input type="button" name="tag" value="Add" class="btn btn-primary col-12"
                            style="margin-top:10px;" onclick="add_tags()">
                        <span id="error"></span>
