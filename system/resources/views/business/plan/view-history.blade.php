        ...
        <div class="invoice">
          ...
          <div class="row">
            <div class="col-6 text-md-left invoice_button">
              <a href="{{ route('business.viewInvoice',$transaction->id) }}" class="btn btn-primary btn-icon icon-left"><i class="fas fa-eye"></i> View Invoice</a>
            </div>
            <div class="col-6 text-md-right invoice_button">
              <a href="{{ route('business.downloadHistory',$transaction->id) }}" class="btn btn-primary btn-icon icon-left"><i class="fas fa-download"></i> Download Invoice</a>
            </div>
          </div>
