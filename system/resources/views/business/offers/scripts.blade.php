    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h3 class="text-success h5 font-weight-bold mb-0">Saved Successfully.</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- ========================================= SCRIPT If Page type Own Website================================ -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @php
                    $offer_content = '<meta name="description" content="'.$offer->description.'">';
                    $offer_title = '<meta name="og:title" content="'.$offer->title.'">';
                    $offer_image = '<meta name="og:image" content="'.asset('assets/img/default_website_img.jpg').'">';
                ...
                <div class="">
                    <div>
                        ...
                        <a href="{{ route('business.designOffer') }}" class="btn btn-primary btn-sm px-3 mr-3">
                            <i class="fas fa-arrow-left"></i> 
                            Back To Designs
                        </a>

                        <a href="{{ $offer->website_url }}" target="_blank" class="btn btn-info btn-sm px-3">
                            Preview Webpage
