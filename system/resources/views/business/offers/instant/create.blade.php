...
@section('title', 'Create Offer: Business')
@section('end_head')<style>label span{color:red;}</style>@endsection
@section('head') @include('layouts.partials.headersection',['title'=>'New Instant Offer']) @endsection
@section('content')
...
<section class="section">
    ...
    <div class="section-body">
        ...
        <form  id="instantform" action="{{ route('business.instant.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-7 col-xl-6">
                ...
                <div class="card" id="offer_details">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-4"><img id="preview_oi" src="" style="max-height:120px;margin-bottom: 30px;" class="img-fluid" />
                                <i class="fa fa-times remove-business-logo" style="display:none" id="removeLogo" aria-hidden="true" data-toggle="tooltip" title="Remove Logo"></i></div>
                        </div>
                        <div class="form-group">
                            <label>Offer Description <span>*</span></label>
                            <textarea class="form-control" name="offer_description" rows="3" required></textarea>
                        </div>
                        <div class="form-group">
                            <label>Number of challenge to complete ( Optional )</label>
                            <input type="text" name="target" id="target" class="form-control" placeholder="Enter task count...">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-6 mb-3">
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="radio" id="coupon_percentage" name="discount_type" value="Percentage" data-name="percentage" class="custom-control-input discount_type_input" checked>
                        ...
                        <div class="form-group" id="coupon_percentage_input">
                            <label for="">Discount in Percentage (%) <span>*</span> </label>
                            <input type="text" name="discount_percent" class="form-control" min="0" max="100" placeholder="Enter Percentage between 0 to 100%" >
                        </div>
                        <div class="form-group" id="coupon_amount_input" style="display:none;">
                            <label for="">Discount in Amount (&#8377;) <span>*</span></label>
                            <input type="text" name="discount_amount" class="form-control" min="0" placeholder="Enter Amount from 0">
                        </div>
            ...
            <div class="col-md-5 col-xl-6">
                ...
                <div class="card" id="FACEBOOK">
                    ...
                    <div class="card-body">
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#fb2" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fb_page_url" class="form-control" placeholder="112977887546093" >
                                            </div>
                                        </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#fb3" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="fb_post_url" class="form-control" placeholder="https://www.facebook.com/url-of-the-post" >
                                            </div>
                                        </div>
                ...
                <div class="card" id="INSTAGRAM">
                    ...
                    <div class="card-body">
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#ig2" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="insta_profile_url" class="form-control" placeholder="https://www.instagram.com/url-of-profile" >
                                            </div>
                                        </div>
                                    </div>
                                  </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#ig3" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center mb-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="insta_post_url" class="form-control" placeholder="https://www.instagram.com/url-of-the-post" >
                                            </div>
                                        </div>
                ...
                <div class="card" id="TWITTER">
                    ...
                    <div class="card-body">
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#tw4" aria-expanded="false">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="tw_username" class="form-control" placeholder="" >
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#tw5" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center mb-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="tw_tweet_like" class="form-control" placeholder="https://twitter.com/OpenChallengek/status/1468094073454006..." >
                                            </div>
                                        </div>
                ...
                <div class="card" id="LINKEDIN">
                    ...
                    <div class="card-body">
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#li1" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center mb-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="li_company_url" class="form-control" placeholder="https://www.linkedin.com/company/hsft873jhsg" >
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card" id="YOUTUBE">
                    ...
                    <div class="card-body">
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#yt1" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center mb-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="yt_channel_url" class="form-control" placeholder="https://www.youtube.com/channel/hsft873jhsg" >
                                            </div>
                                        </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#yt2" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center mb-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="yt_comment_url" class="form-control" placeholder="https://www.youtube.com/watch?v=ZRhwHEoX..." >
                                            </div>
                                        </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#yt3" aria-expanded="false">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                               <div class="d-flex justify-content-between">
                                                ...
                                                <input type="url" name="yt_like_url" class="form-control" placeholder="https://www.youtube.com/watch?v=ZRhwHEoX..." >
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row align-items-center mb-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="google_link" class="form-control" placeholder="https://www.google.com/search?q=..." >
                                            </div>
                                        </div>
                ...
                <div class="card" id="WEBPAGE">
                    ...
                    <div class="card-body">
                        ...
                        <div class="accordion">
                            <div class="accordion-header collapsed" role="button" data-toggle="collapse" data-target="#vp1" aria-expanded="false">
                                    ...
                                    <div class="form-row align-items-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="visit_page_title" class="form-control" value="" placeholder="e.g: Visit MouthPublicity Page" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="url" name="visit_page_url" class="form-control" placeholder="https://www.example.com/" placeholder="" >
                                            </div>
                                        </div>
                                    </div>
                                  </div>
