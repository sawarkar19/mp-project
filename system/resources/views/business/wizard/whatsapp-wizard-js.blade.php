<script type="text/javascript">
    ...
    /* get instance id*/
    var action = '{{ $planData['wa_url']->value }}/api';
    var access_token = '{{ $planData['userData']->wa_access_token }}';
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.status == 'success') {
                        ...
                        var wa_instance_id =
                            '{{ isset($planData['wa_session']->instance_id) ? $planData['wa_session']->instance_id : '' }}';
                        if (wa_instance_id != '') {
                            $.ajax({
                                url: '{{ route('business.removeInstance') }}',
                                type: 'POST',
                                data: {
                                    "user_id": {{ $planData['business_detail']->user_id }},
                                    "_token": $('meta[name="csrf-token"]').attr('content')
                                },
                                dataType: "json",
                                success: function(record) {
    ...
    @if (!$planData['wa_session'] || $planData['wa_session']->instance_id == '')
