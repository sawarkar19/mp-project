...
@section('head') @include('layouts.partials.headersection', ['title' => 'Modify Task']) @endsection
@section('content')
                            ...
                            <div class="card-body" id="scoial_media">
                                <div class="dropdown facebook d-inline mr-2 mb-2">
                                    ...
                                    <div class="dropdown-menu tooltip-color">
                                        {{-- fb_page_url --}}
                                        @if (isset($task_status['task_1']) && $task_status['task_1'] == 0)
                                            <a class="dropdown-item facebook_follow" data-task_key="{{ $tasks_keys['fb_page_url']->task_key }}" data-task_added_through="{{ $tasks_keys['fb_page_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['fb_page_url']->is_automatic ?? 0 }}" href="#" id="fb_follow_pg_opt">Like Our Page</a>
                                        @else
                                            <a class="dropdown-item facebook_follow disabled" data-task_key="{{ $tasks_keys['fb_page_url']->task_key }}" data-task_added_through="{{ $tasks_keys['fb_page_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['fb_page_url']->is_automatic ?? 0 }}" href="#" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Like Our Page</a>
                                        @endif

                                        {{-- fb_comment_post_url --}}
                                        @if (isset($task_status['task_2']) && $task_status['task_2'] == 0)
                                            <a class="dropdown-item facebook_comment" href="#" data-task_key="{{ $tasks_keys['fb_comment_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['fb_comment_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['fb_comment_post_url']->is_automatic ?? 0 }}" id="fb_comment_pg_opt">Comment On Our Post</a>
                                        @else
                                            <a class="dropdown-item facebook_comment disabled" data-task_key="{{ $tasks_keys['fb_comment_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['fb_comment_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['fb_comment_post_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Comment On Our Post</a>
                                        @endif
                                        
                                        {{-- fb_like_post_url --}}
                                        @if (isset($task_status['task_3']) && $task_status['task_3'] == 0)
                                            <a class="dropdown-item facebook_like" data-task_key="{{ $tasks_keys['fb_like_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['fb_like_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['fb_like_post_url']->is_automatic ?? 0 }}" href="#" id="fb_like_pg_opt">Like Our Post</a>
                                        @else
                                            <a class="dropdown-item facebook_like disabled" data-task_key="{{ $tasks_keys['fb_like_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['fb_like_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['fb_like_post_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Like Our Post</a>
                                        @endif
                                        
                                        {{-- fb_share_post_url --}}
                                        @if (isset($task_status['task_15']) && $task_status['task_15'] == 0)
                                            <a class="dropdown-item facebook_share" data-task_key="{{ $tasks_keys['fb_share_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['fb_share_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['fb_share_post_url']->is_automatic ?? 0 }}" href="#" id="fb_share_pg_opt"
                                                style="pointer-events: all;">Share Our Post</a>
                                        @else
                                            <a class="dropdown-item facebook_share disabled" data-task_key="{{ $tasks_keys['fb_share_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['fb_share_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['fb_share_post_url']->is_automatic ?? 0 }}" data-toggle="tooltip"
                                                data-placement="top" title="Coming soon..." href="#"
                                                style="pointer-events: all;">Share Our Post</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="dropdown instagram d-inline mr-2 mb-2">
                                    ...
                                    <div class="dropdown-menu">
                                        {{-- insta_profile_url --}}
                                        @if (isset($task_status['task_4']) && $task_status['task_4'] == 0)
                                            <a class="dropdown-item Insta_follow" data-task_key="{{ $tasks_keys['insta_profile_url']->task_key }}" data-task_added_through="{{ $tasks_keys['insta_profile_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['insta_profile_url']->is_automatic ?? 0 }}" href="#" id="insta_follow_pg_opt">Follow Our Profile</a>
                                        @else
                                            <a class="dropdown-item Insta_follow disabled" data-task_key="{{ $tasks_keys['insta_profile_url']->task_key }}" data-task_added_through="{{ $tasks_keys['insta_profile_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['insta_profile_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Follow Our Profile</a>
                                        @endif

                                        {{-- insta_post_url --}}
                                        @if (isset($task_status['task_5']) && $task_status['task_5'] == 0)
                                            <a class="dropdown-item Insta_like" data-task_key="{{ $tasks_keys['insta_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['insta_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['insta_post_url']->is_automatic ?? 0 }}" href="#" id="insta_like_pg_opt">Like Our Post</a>
                                        @else
                                            <a class="dropdown-item Insta_like disabled" data-task_key="{{ $tasks_keys['insta_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['insta_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['insta_post_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Like Our Post</a>
                                        @endif

                                        {{-- insta_comment_post_url --}}
                                        @if (isset($task_status['task_16']) && $task_status['task_16'] == 0)
                                            <a class="dropdown-item Insta_comment_count" data-task_key="{{ $tasks_keys['insta_comment_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['insta_comment_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['insta_comment_post_url']->is_automatic ?? 0 }}" href="#" id="insta_comment_count_pg_opt">Comment on Our Post</a>
                                        @else
                                            <a class="dropdown-item Insta_comment_count disabled" data-task_key="{{ $tasks_keys['insta_comment_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['insta_comment_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['insta_comment_post_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Comment on Our Post</a>
                                        @endif
                                ...
                                <div class="dropdown twitter d-inline mr-2 mb-2">
                                    ...
                                    <div class="dropdown-menu">
                                        {{-- tw_username --}}
                                        @if (isset($task_status['task_6']) && $task_status['task_6'] == 0)
                                            <a class="dropdown-item twitter_follow"  data-task_key="{{ $tasks_keys['tw_username']->task_key }}"  data-task_added_through="{{ $tasks_keys['tw_username']->task_added_through }}" data-is_automatic="{{ $tasks_keys['tw_username']->is_automatic ?? 0 }}" href="#" id="twitter_follow_pg_opt">Follow Our Profile</a>
                                        @else
                                            <a class="dropdown-item twitter_follow disabled"  data-task_key="{{ $tasks_keys['tw_username']->task_key }}"  data-task_added_through="{{ $tasks_keys['tw_username']->task_added_through }}" data-is_automatic="{{ $tasks_keys['tw_username']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Follow Our Profile</a>
                                        @endif

                                        {{-- tw_tweet_url --}}
                                        @if (isset($task_status['task_7']) && $task_status['task_7'] == 0)
                                            <a class="dropdown-item twitter_like" data-task_key="{{ $tasks_keys['tw_tweet_url']->task_key }}" data-task_added_through="{{ $tasks_keys['tw_tweet_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['tw_tweet_url']->is_automatic ?? 0 }}" href="#" id="twitter_like_pg_opt">Like Our Tweet</a>
                                        @else
                                            <a class="dropdown-item twitter_like disabled" data-task_key="{{ $tasks_keys['tw_tweet_url']->task_key }}" data-task_added_through="{{ $tasks_keys['tw_tweet_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['tw_tweet_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Like Our Tweet</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="dropdown linkedin d-inline mr-2 mb-2">
                                    ...
                                    <div class="dropdown-menu">
                                        {{-- li_company_url --}}
                                        @if (isset($task_status['task_8']) && $task_status['task_8'] == 0)
                                            <a class="dropdown-item linkedin_follow" data-task_key="{{ $tasks_keys['li_company_url']->task_key }}" data-task_added_through="{{ $tasks_keys['li_company_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['li_company_url']->is_automatic ?? 0 }}" href="#" id="linkedin_follow_pg_opt">Follow Our Page</a>
                                        @else
                                            <a class="dropdown-item linkedin_follow disabled" data-task_key="{{ $tasks_keys['li_company_url']->task_key }}" data-task_added_through="{{ $tasks_keys['li_company_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['li_company_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Follow Our Page</a> 
                                        @endif

                                        {{-- li_post_url --}}
                                        @if (isset($task_status['task_9']) && $task_status['task_9'] == 0)
                                            <a class="dropdown-item linkedin_follow" data-task_key="{{ $tasks_keys['li_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['li_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['li_post_url']->is_automatic ?? 0 }}" href="#" id="linkedin_like_pg_opt">Like Our Post</a>
                                        @else
                                            <a class="dropdown-item linkedin_follow disabled" data-task_key="{{ $tasks_keys['li_post_url']->task_key }}" data-task_added_through="{{ $tasks_keys['li_post_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['li_post_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Like Our Post</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="dropdown youtube d-inline mr-2 mb-2">
                                    ...
                                    <div class="dropdown-menu">
                                        {{-- yt_channel_url --}}
                                        @if (isset($task_status['task_10']) && $task_status['task_10'] == 0)
                                            <a class="dropdown-item youtube_subscribe" data-task_key="{{ $tasks_keys['yt_channel_url']->task_key }}" data-task_added_through="{{ $tasks_keys['yt_channel_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['yt_channel_url']->is_automatic ?? 0 }}" href="#" id="yt_follow_pg_opt">Subscribe To Our Channel</a>
                                        @else
                                            <a class="dropdown-item youtube_subscribe disabled" data-task_key="{{ $tasks_keys['yt_channel_url']->task_key }}" data-task_added_through="{{ $tasks_keys['yt_channel_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['yt_channel_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Subscribe To Our Channel</a>
                                        @endif

                                        {{-- yt_like_url --}}
                                        @if (isset($task_status['task_11']) && $task_status['task_11'] == 0)
                                            <a class="dropdown-item youtube_like" data-task_key="{{ $tasks_keys['yt_like_url']->task_key }}" data-task_added_through="{{ $tasks_keys['yt_like_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['yt_like_url']->is_automatic ?? 0 }}" href="#" id="yt_like_pg_opt">Like To Our Video</a>
                                        @else
                                            <a class="dropdown-item youtube_like disabled" data-task_key="{{ $tasks_keys['yt_like_url']->task_key }}" data-task_added_through="{{ $tasks_keys['yt_like_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['yt_like_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Like To Our Video</a>
                                        @endif

                                        {{-- yt_comment_url --}}
                                        @if (isset($task_status['task_12']) && $task_status['task_12'] == 0)
                                            <a class="dropdown-item youtube_comment" data-task_key="{{ $tasks_keys['yt_comment_url']->task_key }}" data-task_added_through="{{ $tasks_keys['yt_comment_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['yt_comment_url']->is_automatic ?? 0 }}" href="#" id="yt_comment_pg_opt">Comment To Our Video</a>
                                        @else
                                            <a class="dropdown-item youtube_comment disabled" data-task_key="{{ $tasks_keys['yt_comment_url']->task_key }}" data-task_added_through="{{ $tasks_keys['yt_comment_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['yt_comment_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Comment To Our Video</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="dropdown google d-inline mr-2 mb-2">
                                    ...
                                    <div class="dropdown-menu">
                                        {{-- google_review_link --}}
                                        @if (isset($task_status['task_13']) && $task_status['task_13'] == 0)
                                            <a class="dropdown-item google_review" data-task_key="{{ $tasks_keys['google_review_link']->task_key }}" data-task_added_through="{{ $tasks_keys['google_review_link']->task_added_through }}" data-is_automatic="{{ $tasks_keys['google_review_link']->is_automatic ?? 0 }}" href="#" id="google_follow_pg_opt">Review Us On Google</a>
                                        @else
                                            <a class="dropdown-item google_review disabled" data-task_key="{{ $tasks_keys['google_review_link']->task_key }}" data-task_added_through="{{ $tasks_keys['google_review_link']->task_added_through }}" data-is_automatic="{{ $tasks_keys['google_review_link']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Review Us On Google</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="dropdown website d-inline mr-2 mb-2">
                                    ...
                                    <div class="dropdown-menu">
                                        {{-- visit_page_url --}}
                                        @if (isset($task_status['task_14']) && $task_status['task_14'] == 0)
                                            <a class="dropdown-item website_page" data-task_key="{{ $tasks_keys['visit_page_url']->task_key }}" data-task_added_through="{{ $tasks_keys['visit_page_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['visit_page_url']->is_automatic ?? 0 }}" href="#" id="website_follow_pg_opt">Website URL</a>
                                        @else
                                            <a class="dropdown-item website_page disabled" data-task_key="{{ $tasks_keys['visit_page_url']->task_key }}" data-task_added_through="{{ $tasks_keys['visit_page_url']->task_added_through }}" data-is_automatic="{{ $tasks_keys['visit_page_url']->is_automatic ?? 0 }}" data-toggle="tooltip" data-placement="top" title="Coming soon..." href="#" style="pointer-events: all;">Website URL</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                        <div class="card h-100 mb-0">
                            <div class="card-body">
                                <div class="">
                                    <span class="step mb-3"><b>Step 2:</b></span>
                                    <p class="mb-1">Click on the date and time of the post of which URL you want.</p>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                        <div class="card h-100 mb-0">
                            <div class="card-body">
                                <div class="">
                                    <span class="step mb-3"><b>Step 1:</b></span>
                                    <p class="mb-1">From Home Feed, Click on the date and time of the tweet.</p>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                        <div class="card h-100 mb-0">
                            <div class="card-body">
                                <div class="">
                                    <span class="step mb-3"><b>Step 1:</b></span>
                                    <p class="mb-1">At Home Feed, click on the video whose URL you want.</p>
    ...
    {{-- modal discription for youtube video video --}}
