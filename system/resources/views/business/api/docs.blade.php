							...
							<div class="row">
								<div class="col-md-7">
									<div class="p-3 lh-normal pb-md-5 pb-4 pt-md-5">
										...
										<p class="mb-0">The MouthPublicity Messaging API allows you to integrate your billing software and send messages to your customer’s WhatsApp. You can send billing messages, notifications, alerts, offers, and any custom message to individual customers directly on their WhatsApp.</p>
									</div>
								</div>
								<div class="col-md-5">
							...
							<div class="row">
								...
								<div class="col-md-5">
									<div class="h-100 bg-dark p-3 pt-md-5 pb-md-5">
										<div class="code-area">
											<p class="mb-0"><code class="text-success">Endpoint</code></p>
										...
										<div class="table-responsive">
											<table class="table table-bordered table-striped parameter-table table-sm mb-0">
												...
												<tr>
													<td>username</td>
													<td>string</td>
													<td>Autogenerated by the system after successfully QR code scan. <a href="{{url('business/api-integration/keys')}}">Click here</a> to view your credentials</td>
												</tr>
												<tr>
													<td>password</td>
													<td>string</td>
