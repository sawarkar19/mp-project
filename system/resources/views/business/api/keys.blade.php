...
<section class="section">
    <div class="section-body">
		...
		@if($planData['OpenChallenge_api']>0)
		<div class="card">
		...
		<div class="card">
			<div class="card-body">
				...
				@if($purchaseHistory>0)
					<h4 class="text-center pb-4 pt-3">Your API Keys Plan Has Expired</h4>
				@else
					<h4 class="text-center pb-4 pt-3">Please Purchase API Keys Plan</h4>
				@endif
					<a href="{{route('business.plan')}}"type="button" class="btn btn-primary text-white">Please Upgrade</a>
				</div>
			</div>
		</div>
