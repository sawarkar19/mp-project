...
@section('title', 'Custom Messages: Business Panel')

@section('head')
@include('layouts.partials.headersection', ['title'=>'Custom Contact List'])
@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive custom-table">
                            <table class="table mb-0" id="custom-msg-list-datatable">
                                <thead>
                                    <tr class="text-left">
                                        <th>Sr. No.</th>
                                        <th>Number</th>
...
@push('js')
    ...
    <script>
        $("#custom-msg-list-datatable").DataTable({
            processing: true,
            serverSide: true,
            bPaginate: true,
            autoWidth: false,
            ...
            ajax: {
                'url': "{{ url('business/channel/personalised-messages/get-custom-message-list') }}",
                'type': 'GET',
                'data': function (d) {
                    d._token = "{{ csrf_token() }}";
                    d.id = "{{$id}}"
