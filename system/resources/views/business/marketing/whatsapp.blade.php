@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>'Messaging Api Settings'])
@endsection
@section('content')
 <div class="row">
  <?php
    $number = substr($json->phone_number, 2);
  ?>
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4>{{ __('Messaging API Configuration') }}</h4><br>
      ...
      <div class="card-body">
        ...
        <div class="form-group row mb-4">
         <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" > {{ __('Whatsapp Number') }}</label>
          <div class="col-sm-12 col-md-7" style="display:flex;align-items: center;">
            <span>+91&nbsp;</span>
			<input type="number" class="form-control" required="" name="number" placeholder="Enter Your Whatsapp Number" value="{{ $number ?? '' }}">
          </div>
        </div>
