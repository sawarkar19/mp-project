			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<a href="{{ route('seller.ad.destroy',$row->id) }}" class="btn btn-danger  cancel"><i class="fa fa-trash"></i></a></td>
					</tr>
					<!-- Modal -->
								...
								<div class="modal-body">
									<form method="post" action="{{ route('seller.ads.store') }}" class="basicform_with_reload">
										...
										<div class="form-group">
											...
											<p class="margin0 specify-product-size">Product Image size must be 354px X 354px <img src="{{ asset($row->name) }}" height="100">
										</div>
										<div class="form-group">
											<label>{{ __('Url') }}</label>
			...
			<div class="modal-body">
				<form method="post" action="{{ route('seller.ads.store') }}" class="basicform_with_reload">
					...
					<div class="form-group">
						...
						<p class="margin0 specify-product-size">Product Image size must be 354px X 354px <span class="text-danger">*</span></p>
					</div>
					<div class="form-group">
						<label>{{ __('Url') }}</label>
