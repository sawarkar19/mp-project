                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            href="{{ route('account.planHistory', encrypt($allUser->id)) }}"><i
                                                                    class="far fa-eye"></i>{{ __('View Statements') }}
                                                            </a>

                                                            <a class="dropdown-item has-icon"
                                                            href="{{ route('account.userShow', encrypt($allUser->id)) }}"><i
                                                                    class="far fa-eye"></i>{{ __('View Reports') }}
                                                            </a>
