        ...
        <div class="row justify-content-center_">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" class="ProfileForm basicSettingform" action="{{ route('account.profileUpdate') }}">
                        @csrf
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="ChangePasswordForm" class="mb-0 basicSettingform" action="{{ route('account.profileUpdate') }}">
                            {{-- @csrf --}}
                            <div class="custom-form">
...
@endpush
@section('end_body')
    @include('account.scripts.profile-setting')
@endsection