...
@section('head') @include('layouts.partials.headersection',['title'=>'Profile']) @endsection
        ...
        <div class="row justify-content-center_">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" class="ProfileForm basicSettingform" action="{{ route('account.verifyPasswordUpdate') }}">
                        @csrf
                            <div class="custom-form">
                                <div class="form-group">
                                    <label for="name" class="col-form-label">{{__('Name')}} <span>*</span></label>
                                    <input type="text" name="name" id="name" class="form-control char-spcs-validation" required placeholder="Enter User's  Name" value="{{ Auth::user()->name }}"> 
                                </div>
                                <div class="form-group">
                                    <label for="email" class="col-form-label">{{__('Email ID')}} <span>*</span></label>
                                    <input type="text" name="email" id="email" class="form-control" required placeholder="Enter User's Email"  value="{{ Auth::user()->email }}" readonly> 
                                </div>
                    ...
                    <form method="post" id="basicformMobile">
                        ...
                        <div class="custom-form">
                            <div class="form-group" id="enter_input">
                                <label for="name" id="" class="col-form-label">{{ __('Number ') }} <small>(10 Digit)</small> <span>*</span></label>
                                <input type="text" class="form-control number-validation" maxlength="10" required placeholder="Enter WhatsApp Number" value="{{ Auth::user()->mobile }}" readonly>
                            </div>

                            <div class="form-group" id="enter_input_show">
                                {{--  <label for="name" id="mobile_label" class="col-form-label">{{ __('Number ') }} <small>(10 Digit)</small> <span>*</span></label>  --}}
                                <label for="name" id="resend_name"  style="display:none;" class="col-form-label">{{ __('Mobile Number') }} <span>*</span></label>
                                <input type="text" name="mobile" id="mobile" style="display:none;"  class="form-control number-validation" maxlength="10" required placeholder="Enter WhatsApp Number" value="{{ Auth::user()->mobile }}">
                            </div>
                            <div class="form-group" id="verify_input" style="display:none;">
                                ...
                                <input type="text" name="otp" id="otp" class="form-control no-space-validation number-validation" maxlength="6" required placeholder="Enter OTP Number" value="">
                            </div>
                            <div class="form-group" id="ResendBtn">
                                <button type="button" class="btn btn-info basicbtn2" onClick="resendOTP();">{{ __('Change Number') }}</button>
                            </div>
                            <div class="form-group" id="OtpBtn" style="display:none;">
                            ...
                            <div class="form-group" id="VrfBtn" style="display:none;">
                                ...
                                <div class="d-sm-inline-flex ml-2 p-2">
                                    <span>
                                        <span class="resend-count text-dark">Resend OTP In</span>
                                        <span class="js-timeout text-danger">2:00</span>
                                    </span>
                                </div>

                                <button type="button" id="ReSendOtpBtn" class="btn btn-info basicbtn2" style="display:none;" onClick="resendOTP();">{{ __('Resend OTP ') }}</button>
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" id="ChangePasswordForm" class="mb-0 basicSettingform" action="{{ route('account.verifyPasswordUpdate') }}">
                            {{-- @csrf --}}
                            <div class="custom-form">
...
<script>
    ...
    $(document).ready(function(){
        setTimeout('$(".js-timeout").hide()',3000);
        setTimeout('$(".js-timeout").show()',3000);
    });
</script>
@endpush
@section('end_body')
    @include('account.profile-js')
@endsection