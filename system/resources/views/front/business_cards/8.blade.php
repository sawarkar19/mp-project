...
<head>
    ...
    <style>
        ...
        .busines-name-sec hr {
            border-bottom: 2px solid #63b545;
            opacity: 1;
            width: 129px;
...
<body>
    ...
    <div class="vbg-color-shade">
        <div class="container pt-md-5">
            ...
            <div class="bg-card-box px-4 py-3 text-white mt-5">
            <div class="row align-items-center">
                <div class="col-md-6 order-2 order-md-1">
                    <div class="busines-name-sec">
                        @if($businessDetail->business_name!='')
                            <h5 class="h5">{{ $businessDetail->business_name }}</h5>
                        @endif
                        ...
                        <div class="qr-box my-2 my-md-4 mx-md-auto">
                            ...
                            <div class="qr-box mx-md-auto">
                                @php
                                    ...
                                    $QR_logo = asset('assets/website/images/logos/QR-icon-light.png');
                                @endphp

                                <img class="img-fluid" src="data:image/png;base64, {!! base64_encode(QrCode::size(250)->encoding('UTF-8')->format('png')->gradient(64, 73, 96, 35, 44, 68, 'diagonal')->margin(1)->merge($QR_logo, .25, true)->generate($vcard)) !!} ">
                            </div>
                    ...
                    <div class="text-md-center">
                        <ul class="qr_social_icons">
                            ...
                            @if($businessDetail->twitter_link != '')
                                <li class="qr_inner_social_icons">
                                    <a href="{{ $businessDetail->twitter_link }}" target="_blank" target="_blank" title="Twitter"><i class="bi bi-twitter"></i></a>
                                </li>
                            @endif
