                    ...
                    <div class="">
                        <div class="qr_code text-center">
                            <div class="qr-box mx-auto">
                                ...
                                @endphp
                                <img class="img-fluid" src="data:image/png;base64, {!! base64_encode(QrCode::size(250)->encoding('UTF-8')->format('png')->gradient(40, 182, 169, 0, 42, 156, 'diagonal')->margin(1)->merge($QR_logo, .3, true)->generate($vcard)) !!} ">        
                            </div>
