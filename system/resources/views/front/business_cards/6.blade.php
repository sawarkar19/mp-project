                    ...
                    <div class="qr_code text-center">
                        <div class="qr-code-inner">
                            ...
                            <div class="qr-box">
                                ...
                                <img class="img-fluid" src="data:image/png;base64, {!! base64_encode(QrCode::size(250)->encoding('UTF-8')->format('png')->gradient(40, 120, 130, 6, 56, 45, 'diagonal')->margin(1)->merge($QR_logo, .25, true)->generate($vcard)) !!} ">
                            </div>
