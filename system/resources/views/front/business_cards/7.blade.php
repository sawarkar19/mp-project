                        ...
                        <div class="qr_code text-center">
                            <div class="qr-code-inner">
                                ...
                                <div class="qr-box">
                                    ...
                                    <img class="img-fluid" src="data:image/png;base64, {!! base64_encode(QrCode::size(250)->encoding('UTF-8')->format('png')->gradient(123, 73, 58, 63, 15, 0, 'diagonal')->margin(1)->merge($QR_logo, .25, true)->generate($vcard)) !!} ">
                                </div>
                                {{-- <i class="bi bi-qr-code"></i> --}}
                            </div>
                            <p class="mt-2 small">Scan this above QR Code to save our contact details</p>
                        </div>
                        <div class="vcard-inner-bg p-2">
                            ...
                            <ul class="user_details">
                                ...
                                {{-- @if($businessDetail->owner->mobile!='')
                                    <li class="number"><i class="bi bi-telephone-fill"></i> <a href="tel:{{ $businessDetail->owner->mobile }}">{{ $businessDetail->owner->mobile }}</a> </li>
                                @endif --}}
