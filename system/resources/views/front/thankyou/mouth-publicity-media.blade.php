           ...
           <div class="mb-5">
            ...
            <div class="row justify-content-between text-center">
                ...
                <div class="mt-5">
                    ...
                    <div class="">
                        <p class="text-left">Hey there,</p>
                        <p class="text-left">Congrats! Welcome to our community.</p>
                        <p class="text-left">Let's start your journey with OpenChallenge now, boost your business with your own customer.</p>
                        <p class="text-left">Thank You,</p>
                        <p class="text-left">OpenChallenge Team</p>
                    </div>
                    <div class="mt-5">
