                                            ...
                                            @if($isComingSoon==0)
                                                @php
                                                    ...
                                                    if(!in_array($instantTask->id, $completedTasks)){
                                                        // Facebook Page Like And Post Like
                                                        if($tasks[$instantTask->task_id]=="fb_page_url" || $tasks[$instantTask->task_id]=="fb_like_post_url"){
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                <span class="pending_task_'.$instantTask->id.'">
                                                                    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="none" stroke="#65676b" stroke-width="18" d="m103.1 213.2v-71.5c0-17.6 4.9-34.8 14.2-49.8 5.6-9 18.3-23.5 25.4-31 1.6-1.7 7.4-6.6 7.4-9.3 0-3.5 0.3-9.1 0.5-19.6 0.1-6.6 5.5-12.1 12.1-12h0.3c11.6 0.2 15.3 10.9 15.3 10.9 0 0 9.9 19.6 0.6 43.6-7.8 20.2-9.4 21.8-9.4 21.8 0 0-2.5 3.7 5.5 3.5 0 0 48.8-0.2 50.5-0.2 3.6 0 15.1 3.3 14.5 18-0.5 10.8-7.2 14.6-10.7 15.8-0.4 0.2-0.7 0.7-0.5 1.2q0.1 0.2 0.4 0.4c3.5 2.1 10.7 7.2 10.6 15.2-0.2 9.6-4.1 13.2-12.1 15.4-0.5 0.1-0.8 0.6-0.6 1 0 0.2 0.2 0.4 0.3 0.5 3.1 1.8 8.3 6 8 14.6-0.3 8.7-6.6 11.8-10.1 12.9-0.4 0.1-0.7 0.6-0.5 1 0 0.2 0.1 0.4 0.3 0.5 2.2 1.5 5.4 4.9 5.3 11.8-0.1 3.7-1.3 6.4-2.9 8.3-2.4 3.1-6.3 4.6-10.2 4.7l-108.4 0.2c0 0-5.8 0-5.8-7.9z" /><path fill="none" stroke="#65676b" stroke-width="18" stroke-linejoin="round" d="m24 132c0-5.5 4.5-10 10-10h33c5.5 0 10 4.5 10 10v92c0 5.5-4.5 10-10 10h-33c-5.5 0-10-4.5-10-10z" /></svg>    
                                                                </span>

                                                                <span class="processing_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="rotate" viewBox="0 0 16 16"><path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"/><path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"/></svg>
                                                                </span>

                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="#0571ed" stroke="#0571ed" stroke-width="18" d="m103.1 213.2v-71.5c0-17.6 4.9-34.8 14.2-49.8 5.6-9 18.3-23.5 25.4-31 1.6-1.7 7.4-6.6 7.4-9.3 0-3.5 0.3-9.1 0.5-19.6 0.1-6.6 5.5-12.1 12.1-12h0.3c11.6 0.2 15.3 10.9 15.3 10.9 0 0 9.9 19.6 0.6 43.6-7.8 20.2-9.4 21.8-9.4 21.8 0 0-2.5 3.7 5.5 3.5 0 0 48.8-0.2 50.5-0.2 3.6 0 15.1 3.3 14.5 18-0.5 10.8-7.2 14.6-10.7 15.8-0.4 0.2-0.7 0.7-0.5 1.2q0.1 0.2 0.4 0.4c3.5 2.1 10.7 7.2 10.6 15.2-0.2 9.6-4.1 13.2-12.1 15.4-0.5 0.1-0.8 0.6-0.6 1 0 0.2 0.2 0.4 0.3 0.5 3.1 1.8 8.3 6 8 14.6-0.3 8.7-6.6 11.8-10.1 12.9-0.4 0.1-0.7 0.6-0.5 1 0 0.2 0.1 0.4 0.3 0.5 2.2 1.5 5.4 4.9 5.3 11.8-0.1 3.7-1.3 6.4-2.9 8.3-2.4 3.1-6.3 4.6-10.2 4.7l-108.4 0.2c0 0-5.8 0-5.8-7.9z" /><path fill="#0571ed" stroke="#0571ed" stroke-width="18" stroke-linejoin="round" d="m24 132c0-5.5 4.5-10 10-10h33c5.5 0 10 4.5 10 10v92c0 5.5-4.5 10-10 10h-33c-5.5 0-10-4.5-10-10z" /></svg>
                                                                </span>
                                                            </span>';
                                                        }
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                <span class="pending_task_'.$instantTask->id.'">
                                                                    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="none" stroke="#65676b" stroke-width="22" d="m17 48c0-16.6 13.4-30 30-30h164c16.6 0 30 13.4 30 30v111c0 16.6-13.4 30-30 30h-68l-74.8 43.5-0.2-43.5h-21c-16.6 0-30-13.4-30-30z" /></svg>
                                                                </span>
                                                                ...
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="#0571ed" stroke="#0571ed" stroke-width="22" d="m17 48c0-16.6 13.4-30 30-30h164c16.6 0 30 13.4 30 30v111c0 16.6-13.4 30-30 30h-68l-74.8 43.5-0.2-43.5h-21c-16.6 0-30-13.4-30-30z" /></svg>
                                                                </span>
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                    <span class="pending_task_'.$instantTask->id.'">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><path d="M448,256,272,88v96C103.57,184,64,304.77,64,424c48.61-62.24,91.6-96,208-96v96Z" style="fill:none;stroke:#65676b;stroke-linejoin:round;stroke-width:40px"/></svg>
                                                                </span>
                                                                ...
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><path d="M448,256,272,88v96C103.57,184,64,304.77,64,424c48.61-62.24,91.6-96,208-96v96Z" style="fill:#0571ed;stroke:#0571ed;stroke-linejoin:round;stroke-width:40px"/></svg>
                                                                </span>
                                                        ...
                                                        // INSTAGRAM
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                    <span class="pending_task_'.$instantTask->id.'">
                                                                    <button class="insta_follow_btn">Follow</button>
                                                                </span>
                                                                ...
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;"><button class="insta_follow_btn followed">Following</button></span>
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                ...
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg aria-label="Comment" color="#262626" fill="none" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="#262626" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
                                                                </span>
                                                            </span>';
                                                        ...
                                                        // Twitter
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                <span class="pending_task_'.$instantTask->id.'">
                                                                    <button class="twit_follow_btn">Follow</button>
                                                                </span>
                                                                ...
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <button class="twit_follow_btn followed">Following</button>
                                                                </span>
                                                            </span>';
                                                        }
                                                        ...
                                                        // LinkedIn
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                <span class="pending_task_'.$instantTask->id.'">
                                                                    <button class="link_follow_btn"><svg viewBox="0 0 16 16" fill="currentColor" width="12" height="12"><path d="M14 9H9v5H7V9H2V7h5V2h2v5h5z"></path></svg>Follow</button>
                                                                </span>
                                                                <span class="processing_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="rotate" viewBox="0 0 16 16"><path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"/><path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"/></svg>
                                                                </span>
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <button class="link_follow_btn followed"><svg viewBox="0 0 16 16" fill="currentColor" width="12" height="12"><path d="M12.57 2H15L6 15l-5-5 1.41-1.41 3.31 3.3z"></path></svg>Following</button>
                                                                </span>
                                                            </span>';
                                                        }
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                <span class="pending_task_'.$instantTask->id.'">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="#666" d="M19.46 11l-3.91-3.91a7 7 0 01-1.69-2.74l-.49-1.47A2.76 2.76 0 0010.76 1 2.75 2.75 0 008 3.74v1.12a9.19 9.19 0 00.46 2.85L8.89 9H4.12A2.12 2.12 0 002 11.12a2.16 2.16 0 00.92 1.76A2.11 2.11 0 002 14.62a2.14 2.14 0 001.28 2 2 2 0 00-.28 1 2.12 2.12 0 002 2.12v.14A2.12 2.12 0 007.12 22h7.49a8.08 8.08 0 003.58-.84l.31-.16H21V11zM19 19h-1l-.73.37a6.14 6.14 0 01-2.69.63H7.72a1 1 0 01-1-.72l-.25-.87-.85-.41A1 1 0 015 17l.17-1-.76-.74A1 1 0 014.27 14l.66-1.09-.73-1.1a.49.49 0 01.08-.7.48.48 0 01.34-.11h7.05l-1.31-3.92A7 7 0 0110 4.86V3.75a.77.77 0 01.75-.75.75.75 0 01.71.51L12 5a9 9 0 002.13 3.5l4.5 4.5H19z"></path></svg>
                                                                </span>
                                                                <span class="processing_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="rotate" viewBox="0 0 16 16"><path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"/><path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"/></svg>
                                                                </span>
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g><path fill="none" d="M0 0h24v24H0z"/><path d="M12.69 9.5H5.06a1.8 1.8 0 00-1.56 2A1.62 1.62 0 005.15 13h.29a1.38 1.38 0 00-1.34 1.39 1.43 1.43 0 001.31 1.42A1.42 1.42 0 006 18.35a1.45 1.45 0 00-.15 1 1.51 1.51 0 001.51 1.12h4.08a6.3 6.3 0 001.56-.2l2.56-.75h3.38c1.78-.07 2.26-8.26 0-8.26h-1c-.17 0-.27-.34-.71-.82-.65-.71-1.39-1.62-1.91-2.13a12.62 12.62 0 01-3-3.92C11.9 3.42 11.85 3 11 3a1.38 1.38 0 00-1.21 1.45c0 .25.13 1.12.18 1.43a10.6 10.6 0 001.76 3.62" fill="#378fe9" fill-rule="evenodd"/><path d="M5.06 10a1.42 1.42 0 00-1.56 1.5A1.6 1.6 0 005.15 13h.29a1.37 1.37 0 00-1.34 1.41 1.43 1.43 0 001.31 1.42A1.42 1.42 0 006 18.37a1.45 1.45 0 00-.15 1 1.53 1.53 0 001.52 1.13h4.08a6.8 6.8 0 001.55-.21l2.56-.75h3.38c1.78-.07 2.26-8.26 0-8.26h-1c-.17 0-.27-.34-.71-.82-.65-.71-1.39-1.62-1.91-2.13a12.62 12.62 0 01-3-3.92C11.9 3.44 11.85 3 11 3a1.29 1.29 0 00-.91.48 1.32 1.32 0 00-.3 1c0 .25.13 1.12.18 1.43A15.82 15.82 0 0011.73 10z" fill="none" stroke="#004182" stroke-linecap="round" stroke-linejoin="round"/></g></svg>
                                                                </span>
                                                            </span>';
                                                        }
                                                        ...
                                                        // YOUTUBE
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                <span class="pending_task_'.$instantTask->id.'">
                                                                    <button class="yt_subscribe_btn">Subscribe</button>
                                                                </span>
                                                                <span class="processing_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="rotate" viewBox="0 0 16 16"><path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"/><path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"/></svg>
                                                                </span>
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <button class="yt_subscribe_btn subscribed">Subscribed</button>
                                                                </span>
                                                            </span>';
                                                        }
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                <span class="pending_task_'.$instantTask->id.'">
                                                                    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="none" stroke="#000" stroke-width="20" d="m15 117.7h30.9v115.5h-30.9z" /><path fill="none" stroke="#000" stroke-width="20" d="m73.7 113.2l68.7-73.6c0 0 15.1-16.1 27-9.3 11.9 6.8 9.8 23.1 6.5 35.3-3.3 12.2-12.1 47.6-12.1 47.6h48.3c0 0 27.9-0.8 27.9 16.5 0 17.3-16.7 85.5-16.7 85.5 0 0-3.2 17.3-25.1 17.3-21.9 0-125.4 0-125.4 0z" /></svg>
                                                                </span>
                                                                <span class="processing_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="rotate" viewBox="0 0 16 16"><path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"/><path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"/></svg>
                                                                </span>
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="#000" stroke="#000" stroke-width="20" d="m15 117.7h30.9v115.5h-30.9z" /><path fill="#000" stroke="#000" stroke-width="20" d="m73.7 113.2l68.7-73.6c0 0 15.1-16.1 27-9.3 11.9 6.8 9.8 23.1 6.5 35.3-3.3 12.2-12.1 47.6-12.1 47.6h48.3c0 0 27.9-0.8 27.9 16.5 0 17.3-16.7 85.5-16.7 85.5 0 0-3.2 17.3-25.1 17.3-21.9 0-125.4 0-125.4 0z" /></svg>
                                                                </span>
                                                            </span>';
                                                        }
                                                        ...
                                                        // Google Review
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                ...
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16"><path fill="#f8b704" d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg>
                                                                </span>
                                                            </span>';
                                                        }
                                                        ...
                                                        // WEBSITE
                                                            ...
                                                            $reddemIcon = '<span class="task_container" id="task_container_'.$instantTask->id.'">
                                                                ...
                                                                <span class="complete_task_'.$instantTask->id.'" style="display: none;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16"><path fill="blue" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm7.5-6.923c-.67.204-1.335.82-1.887 1.855-.143.268-.276.56-.395.872.705.157 1.472.257 2.282.287V1.077zM4.249 3.539c.142-.384.304-.744.481-1.078a6.7 6.7 0 0 1 .597-.933A7.01 7.01 0 0 0 3.051 3.05c.362.184.763.349 1.198.49zM3.509 7.5c.036-1.07.188-2.087.436-3.008a9.124 9.124 0 0 1-1.565-.667A6.964 6.964 0 0 0 1.018 7.5h2.49zm1.4-2.741a12.344 12.344 0 0 0-.4 2.741H7.5V5.091c-.91-.03-1.783-.145-2.591-.332zM8.5 5.09V7.5h2.99a12.342 12.342 0 0 0-.399-2.741c-.808.187-1.681.301-2.591.332zM4.51 8.5c.035.987.176 1.914.399 2.741A13.612 13.612 0 0 1 7.5 10.91V8.5H4.51zm3.99 0v2.409c.91.03 1.783.145 2.591.332.223-.827.364-1.754.4-2.741H8.5zm-3.282 3.696c.12.312.252.604.395.872.552 1.035 1.218 1.65 1.887 1.855V11.91c-.81.03-1.577.13-2.282.287zm.11 2.276a6.696 6.696 0 0 1-.598-.933 8.853 8.853 0 0 1-.481-1.079 8.38 8.38 0 0 0-1.198.49 7.01 7.01 0 0 0 2.276 1.522zm-1.383-2.964A13.36 13.36 0 0 1 3.508 8.5h-2.49a6.963 6.963 0 0 0 1.362 3.675c.47-.258.995-.482 1.565-.667zm6.728 2.964a7.009 7.009 0 0 0 2.275-1.521 8.376 8.376 0 0 0-1.197-.49 8.853 8.853 0 0 1-.481 1.078 6.688 6.688 0 0 1-.597.933zM8.5 11.909v3.014c.67-.204 1.335-.82 1.887-1.855.143-.268.276-.56.395-.872A12.63 12.63 0 0 0 8.5 11.91zm3.555-.401c.57.185 1.095.409 1.565.667A6.963 6.963 0 0 0 14.982 8.5h-2.49a13.36 13.36 0 0 1-.437 3.008zM14.982 7.5a6.963 6.963 0 0 0-1.362-3.675c-.47.258-.995.482-1.565.667.248.92.4 1.938.437 3.008h2.49zM11.27 2.461c.177.334.339.694.482 1.078a8.368 8.368 0 0 0 1.196-.49 7.01 7.01 0 0 0-2.275-1.52c.218.283.418.597.597.932zm-.488 1.343a7.765 7.765 0 0 0-.395-.872C9.835 1.897 9.17 1.282 8.5 1.077V4.09c.81-.03 1.577-.13 2.282-.287z"/></svg>
                                                                </span>
                                                            </span>';
                                                        }
                                                    }else{
                                                        // Facebook Page Like And Post Like
                                                        if($tasks[$instantTask->task_id]=="fb_page_url" || $tasks[$instantTask->task_id]=="fb_like_post_url"){
                                                            $reddemIcon = '<svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="#0571ed" stroke="#0571ed" stroke-width="18" d="m103.1 213.2v-71.5c0-17.6 4.9-34.8 14.2-49.8 5.6-9 18.3-23.5 25.4-31 1.6-1.7 7.4-6.6 7.4-9.3 0-3.5 0.3-9.1 0.5-19.6 0.1-6.6 5.5-12.1 12.1-12h0.3c11.6 0.2 15.3 10.9 15.3 10.9 0 0 9.9 19.6 0.6 43.6-7.8 20.2-9.4 21.8-9.4 21.8 0 0-2.5 3.7 5.5 3.5 0 0 48.8-0.2 50.5-0.2 3.6 0 15.1 3.3 14.5 18-0.5 10.8-7.2 14.6-10.7 15.8-0.4 0.2-0.7 0.7-0.5 1.2q0.1 0.2 0.4 0.4c3.5 2.1 10.7 7.2 10.6 15.2-0.2 9.6-4.1 13.2-12.1 15.4-0.5 0.1-0.8 0.6-0.6 1 0 0.2 0.2 0.4 0.3 0.5 3.1 1.8 8.3 6 8 14.6-0.3 8.7-6.6 11.8-10.1 12.9-0.4 0.1-0.7 0.6-0.5 1 0 0.2 0.1 0.4 0.3 0.5 2.2 1.5 5.4 4.9 5.3 11.8-0.1 3.7-1.3 6.4-2.9 8.3-2.4 3.1-6.3 4.6-10.2 4.7l-108.4 0.2c0 0-5.8 0-5.8-7.9z" /><path fill="#0571ed" stroke="#0571ed" stroke-width="18" stroke-linejoin="round" d="m24 132c0-5.5 4.5-10 10-10h33c5.5 0 10 4.5 10 10v92c0 5.5-4.5 10-10 10h-33c-5.5 0-10-4.5-10-10z" /></svg>';
                                                        }
                                                        else if($tasks[$instantTask->task_id]=="fb_comment_post_url"){
                                                            $reddemIcon = '<svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="#0571ed" stroke="#0571ed" stroke-width="22" d="m17 48c0-16.6 13.4-30 30-30h164c16.6 0 30 13.4 30 30v111c0 16.6-13.4 30-30 30h-68l-74.8 43.5-0.2-43.5h-21c-16.6 0-30-13.4-30-30z" /></svg>';
                                                        }
                                                        else if($tasks[$instantTask->task_id]=="fb_share_post_url"){
                                                            $reddemIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><path d="M448,256,272,88v96C103.57,184,64,304.77,64,424c48.61-62.24,91.6-96,208-96v96Z" style="fill:#0571ed;stroke:#0571ed;stroke-linejoin:round;stroke-width:40px"/></svg>';
                                                        }

                                                        // INSTAGRAM
                                                        else if($tasks[$instantTask->task_id]=="insta_profile_url"){
                                                            $reddemIcon = '<button class="insta_follow_btn followed">Following</button>';
                                                        }
                                                        else if($tasks[$instantTask->task_id]=="insta_post_url"){
                                                            $reddemIcon = '<svg aria-label="Unlike" color="#ed4956" fill="#ed4956" height="24" role="img" viewBox="0 0 48 48" width="24"><path d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"></path></svg>';
                                                        }
                                                        else if($tasks[$instantTask->task_id]=="insta_comment_post_url"){
                                                            $reddemIcon = '<svg aria-label="Comment" color="#262626" fill="none" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="#262626" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>';
                                                        }

                                                        // Twitter
                                                        else if($tasks[$instantTask->task_id]=="tw_username"){
                                                            $reddemIcon = '<button class="twit_follow_btn followed">Following</button>';
                                                        }
                                                        else if($tasks[$instantTask->task_id]=="tw_tweet_url"){
                                                            $reddemIcon = '<svg viewBox="2 2 21 21" width="24" height="24"><path fill="rgb(249, 24, 128)" d="M20.884 13.19c-1.351 2.48-4.001 5.12-8.379 7.67l-.503.3-.504-.3c-4.379-2.55-7.029-5.19-8.382-7.67-1.36-2.5-1.41-4.86-.514-6.67.887-1.79 2.647-2.91 4.601-3.01 1.651-.09 3.368.56 4.798 2.01 1.429-1.45 3.146-2.1 4.796-2.01 1.954.1 3.714 1.22 4.601 3.01.896 1.81.846 4.17-.514 6.67z"></path></svg>';
                                                        }

                                                        // LinkedIn
                                                        else if($tasks[$instantTask->task_id]=="li_company_url"){
                                                            $reddemIcon = '<button class="link_follow_btn followed"><svg viewBox="0 0 16 16" fill="currentColor" width="12" height="12"><path d="M12.57 2H15L6 15l-5-5 1.41-1.41 3.31 3.3z"></path></svg>Following</button>';
                                                        }
                                                        else if($tasks[$instantTask->task_id]=="li_post_url"){
                                                            $reddemIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g><path fill="none" d="M0 0h24v24H0z"/><path d="M12.69 9.5H5.06a1.8 1.8 0 00-1.56 2A1.62 1.62 0 005.15 13h.29a1.38 1.38 0 00-1.34 1.39 1.43 1.43 0 001.31 1.42A1.42 1.42 0 006 18.35a1.45 1.45 0 00-.15 1 1.51 1.51 0 001.51 1.12h4.08a6.3 6.3 0 001.56-.2l2.56-.75h3.38c1.78-.07 2.26-8.26 0-8.26h-1c-.17 0-.27-.34-.71-.82-.65-.71-1.39-1.62-1.91-2.13a12.62 12.62 0 01-3-3.92C11.9 3.42 11.85 3 11 3a1.38 1.38 0 00-1.21 1.45c0 .25.13 1.12.18 1.43a10.6 10.6 0 001.76 3.62" fill="#378fe9" fill-rule="evenodd"/><path d="M5.06 10a1.42 1.42 0 00-1.56 1.5A1.6 1.6 0 005.15 13h.29a1.37 1.37 0 00-1.34 1.41 1.43 1.43 0 001.31 1.42A1.42 1.42 0 006 18.37a1.45 1.45 0 00-.15 1 1.53 1.53 0 001.52 1.13h4.08a6.8 6.8 0 001.55-.21l2.56-.75h3.38c1.78-.07 2.26-8.26 0-8.26h-1c-.17 0-.27-.34-.71-.82-.65-.71-1.39-1.62-1.91-2.13a12.62 12.62 0 01-3-3.92C11.9 3.44 11.85 3 11 3a1.29 1.29 0 00-.91.48 1.32 1.32 0 00-.3 1c0 .25.13 1.12.18 1.43A15.82 15.82 0 0011.73 10z" fill="none" stroke="#004182" stroke-linecap="round" stroke-linejoin="round"/></g></svg>';
                                                        }

                                                        // YOUTUBE
                                                        else if($tasks[$instantTask->task_id]=="yt_channel_url"){
                                                            $reddemIcon = '<button class="yt_subscribe_btn subscribed">Subscribed</button>';
                                                        }
                                                        else if($tasks[$instantTask->task_id]=="yt_like_url"){
                                                            $reddemIcon = '<svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="24" height="24"><path fill="#000" stroke="#000" stroke-width="20" d="m15 117.7h30.9v115.5h-30.9z" /><path fill="#000" stroke="#000" stroke-width="20" d="m73.7 113.2l68.7-73.6c0 0 15.1-16.1 27-9.3 11.9 6.8 9.8 23.1 6.5 35.3-3.3 12.2-12.1 47.6-12.1 47.6h48.3c0 0 27.9-0.8 27.9 16.5 0 17.3-16.7 85.5-16.7 85.5 0 0-3.2 17.3-25.1 17.3-21.9 0-125.4 0-125.4 0z" /></svg>';
                                                        }
                                                        else if($tasks[$instantTask->task_id]=="yt_comment_url"){
                                                            $reddemIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4.414a1 1 0 0 0-.707.293L.854 15.146A.5.5 0 0 1 0 14.793V2zm3.5 1a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 2.5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 2.5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5z"/></svg>';
                                                        }
                                                    ...
                                                    if($tasks[$instantTask->task_id]=="fb_page_url" || $tasks[$instantTask->task_id]=="fb_comment_post_url" || $tasks[$instantTask->task_id]=="fb_like_post_url" || $tasks[$instantTask->task_id]=="fb_share_post_url"){
                                                        ...
                                                        if($tasks[$instantTask->task_id]=="fb_page_url"){
                                                            ...
                                                            $redirectBaseUrl = "https://www.facebook.com/".$instantTask['task_value'];
                                                ...
                                                @if($isTaskShow)
                                                    <div id="set-single-task_{{ $instantTask['id'] }}" class="ins_task border-bottom @if(in_array($instantTask->id, $completedTasks)) completed @endif {{ $iconColor }} {{ $is_hide_task }}">
                                                        <a 
                                                            @if(!in_array($instantTask->id, $completedTasks)) 
                                                                target="_blank"
                                                                ...
                                                                @elseif($tasks[$instantTask->task_id]=="google_review_link")
                                                                    href="{{ $redirectBaseUrl }}" 
                                                                @endif 
                                                                ...
                                                                data-task_value="{{ $task_value }}" data-task_value_browser="{{ $redirectBaseUrlBrowser ?? '' }}" data-task_key="{{ $tasks[$instantTask->task_id] }}"
                                                            ...
                                                            @if($agent->device()=="iPhone" || $agent->device()=="iOS" || $agent->device()=="OS X")
                                                                href="{{ $redirectBaseUrl }}" 
                                                                target="_blank"
                                                            @endif
                                                        >
                                                            ...
                                                            <div class="inner d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div class="tic_ico verifing_conent_{{ $tasks[$instantTask->task_id] }}">
                                                                    <span class="verifing_loader_{{ $tasks[$instantTask->task_id] }}">
