...
<script type="text/javascript">
    ...
    $(document).ready(function(){
         ...
         $(document).on('click', '.fb-post-link', function(){
              ...
              // }, 2000);
              if(task_key=="fb_comment_post_url"){
                   setTasks(checkFacebookPostComment, instant_task_id);
              }
              else if(task_key=="fb_like_post_url"){
                   setTasks(checkFacebookPostLike, instant_task_id);
              }
         });

         function setTasks(callback, instant_task_id){
              // console.log("callback ",callback, " instant_task_id ", instant_task_id);
