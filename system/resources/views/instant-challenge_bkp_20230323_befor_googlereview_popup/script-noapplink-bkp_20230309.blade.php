<script type="text/javascript">
     ...
     function checkDeviceBrowser(){
          ...
          //      isTaskListShow = true;
          // }
          if(browserName=="chrome" || browserName=="edge" || browserName=="Safari" || browserName=="safari"){
               isTaskListShow = true;
          }
     }
          ...
          $(document).on('click', '.fb-post-link', function(){
               ...
               */
               ...
               if(osCheck=="iPhone" || osCheck=="iOS" || osCheck=="OS X"){
                    ...
                    var getBrowserName = "{{ $agent->browser() ?? NULL }}";
                    if(getBrowserName!="Chrome" && getBrowserName!="Edge"){
                         window.open(noapplink, '_blank');
                    }
                    ...
                    setTimeout(function() {
                         if (window.isActive == true) {
                              if(osCheck != 'Windows' && getBrowserName!="Safari" && getBrowserName!="safari"){
                                   if(isDevice=="desktop"){
                                        window.open(noapplink, '_blank');
                                   }
                                   else{
