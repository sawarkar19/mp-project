            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-5 order-lg-2">
                        <div class="">
                            <img src="assets/images/home-banner.svg" class="img-fluid" alt="Personalised greeting">
                        </div>
                    </div>
                    <div class="col-lg-6 mb-5 mb-lg-0 order-lg-1">
                        <div class="banner-block pe-xl-5">
                            <h5 class="mb-5 text-uppercase h2 font-900 color-primary">PERSONALISED GREETING</h1>
            ...
            <div class="box_position">
                <div class="row justify-content-center">
                    <div class="col-sm-6 col-md-5 col-lg-4">
                        <div class="card h-100 bg-dark">
                            <div class="p-3">
                                <img src="{{ asset('assets/trash/dummy_box.png') }}" class="card-img-top" alt="Send Personalized Promotional Messages"> 
                            </div>
                            <div class="card-body h-100 text-white">
                                <h5 class="card-text font-600 h3">Send Personalized Promotional Messages To Customers</h5>
                            </div>
                        </div>
                    </div> 
                    <div class="col-sm-6 col-md-5 col-lg-4 mt-4 mt-sm-0">
                        <div class="card h-100 bg-dark">
                            <div class="p-3">
                                <img src="{{ asset('assets/trash/dummy_box.png') }}" class="card-img-top" alt="Send Exciting Business Updates">
                            </div>
                            <div class="card-body h-100 text-white">
                                <h5 class="card-text font-600 h3">Send Exciting Business Updates Automatically</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center mt-4">
                    <div class="col-sm-6 col-md-5 col-lg-4">
                        <div class="card h-100 bg-dark">
                            <div class="p-3">
                                <img src="{{ asset('assets/trash/dummy_box.png') }}" class="card-img-top" alt="Make Your Customers Feel Special"> 
                            </div>
                            <div class="card-body h-100 text-white">
                                <h5 class="card-text font-600 h3">Make Your Customers Feel Special On Their Birthdays, Anniversaries And Festive Occasions</h5>
                            </div>
                        </div>
                    </div> 
                    <div class="col-sm-6 col-md-5 col-lg-4 mt-4 mt-sm-0">
                        <div class="card h-100 bg-dark">
                            <div class="p-3">
                                <img src="{{ asset('assets/trash/dummy_box.png') }}" class="card-img-top" alt="Remind Your Customers About Your Business">
                            </div>
                            <div class="card-body h-100 text-white">
                                <h5 class="card-text font-600 h3">Remind Your Customers About Your Business To Give Your Brand A Strong Recall Value</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center mt-4">
                    <div class="col-sm-6 col-md-5 col-lg-4">
                        <div class="card h-100 bg-dark">
                            <div class="p-3">
                                <img src="{{ asset('assets/trash/dummy_box.png') }}" class="card-img-top" alt="Send Automated Greetings"> 
                            </div>
                            <div class="card-body h-100 text-white">
                                <h5 class="card-text font-600 h3">Send Automated Greetings To Your Customers On Whatsapp</h5>
                            </div>
                        </div>
                    </div> 
                ...
                <div class="hiw-steps">
                    <div class="inner">
                        ...
                        <div class="hiw-steps-dis">
                            <p class="text-center p-4 mb-0">Create the offers and customize and edit the messages you want to send to your customers.</p>
                        </div>
                    </div>
                </div>
                <div class="diagonal-arrow diagonal-arrow-left-HIW"></div>
                <div class="hiw-steps-img hiw-steps-img_left mt-5 mt-md-0">
                    <img src="{{ asset('assets/trash/dummy_img2.png') }}" class="img-fluid" alt="Create Offers">
                </div>
            </div>
            ...
            <div class="hiw-flex">
                <div class="hiw-steps">
                    <div class="inner">
                        ...
                        <div class="hiw-steps-dis">
                            <p class="text-center p-4 mb-0">Send bulk messages, promotional messages, new offers, updates, or greetings in a single click either through WhatsApp or SMS.</p>
                        </div>
                    </div>
                </div>
                <div class="diagonal-arrow diagonal-arrow-right-HIW"></div>
                <div class="hiw-steps-img hiw-steps-img_right mt-5 mt-md-0">
                    <img src="{{ asset('assets/trash/dummy_img2.png') }}" class="img-fluid" alt="Setup Custom Rewards">
                </div>
            </div>
        </div>
    {{--HIW Section Two end--}}
            ...
            <div class="hiw-flex">
                <div class="hiw-steps">
                    <div class="inner">
                        ...
                        <div class="hiw-steps-dis">
                            <p class="text-center p-4 mb-0">Build a connection with your customers to get a happy customer base.</p>
                        </div>
                    </div>
                </div>
                <div class="hiw-steps-img hiw-steps-img_left mt-5 mt-md-0">
                    <img src="{{ asset('assets/trash/dummy_img2.png') }}" class="img-fluid" alt="Share The Offer Link">
                </div>
            </div>
                ...
                <div class="row justify-content-between align-items-center mt-5">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                        <div class="mt-4 mt-md-0">
                            <img src="{{ asset('assets/trash/dummy_box.png') }}"  alt="Give Your Customers A Simple Task" style="width:400px; max-width:100%; border-radius:12px;">
                        </div>
                    </div>
                </div>
            </div>
