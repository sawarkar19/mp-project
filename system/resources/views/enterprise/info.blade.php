...
<body>
    ...
    <section id="whatsapp-scan">
        <div style="display:none" id="enterprise_info_token">{{ $str }}</div>
        ...
        <div class="wp-scan py-5 px-3">
            <div class="container">
                ...
                <div class="wp-scan-card shadow" id="qrForm" style="@if($instanceId != '') display:none; @endif">
                ...
                <div class="info-form-card shadow" id="infoForm" style="@if($instanceId == '') display:none; @endif">  

                    <div class="info-form-card-inner">
                        <div class="row">
                            <div class="@if($userData->is_registration_complete == 0) col-md-6 @else col-md-12 @endif bg-color-gradient br-left-to-top wp-padding position-relative">
    ...
    <script type="text/javascript">
        ...
        function set_key(instance_data){
            ...
            var enterprise_info_token = $("#enterprise_info_token").text();
            ...
            $.ajax({
                ...
                data : {
                    ...
                    "enterprise_info_token": enterprise_info_token,
