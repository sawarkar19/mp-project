...
@section('title', 'Designer: Vcards List')
@section('head')
                                ...
                                <tr id="row{{ $card->id }}">
                                    ...
                                    <td>
                                        <button class="btn btn-primary has-icon"
                                            onclick="window.location.href = '{{ route('designer.vcards.edit',$card->id) }}'"
