...
class TodayExpiryJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if($shortLinkData->original["success"] != false){
            ...
            $payload = \App\Http\Controllers\WACloudApiController::mp_today_expire_alert('91'.$this->user->mobile, $this->user->name, $shortLinkData->original["code"]);
