...
class OneDayExpiryJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if($shortLinkData->original["success"] != false){
            ...
            $payload = \App\Http\Controllers\WACloudApiController::mp_will_1_expire_alert('91'.$this->user->mobile, $this->user->name, $day, $shortLinkData->original["code"]);
