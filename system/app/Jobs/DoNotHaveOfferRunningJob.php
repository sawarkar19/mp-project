...
class DoNotHaveOfferRunningJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $email_info = Email::where('id', 25)->first();
        ...
        $shortLinkData = ShortLinkController::callShortLinkApi($long_link, $this->user->id ?? 0, "offer_not_running");
