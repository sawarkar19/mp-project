...
class SocialpostController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('business.social-posts.index', compact('domain', 'notification_list', 'planData', 'scheduled', 'unscheduled', 'posted', 'businessDetails', 'userSocialConnection', 'isFacebookCheck', 'islinkedInCheck', 'isSocialPost', 'userSocialPlatform', 'activeUserSocialPlatform','isChannelActive'));
    }
