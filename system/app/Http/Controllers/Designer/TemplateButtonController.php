...
class TemplateButtonController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('designer.templates.show', compact('templateButtons'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('designer.templatebuttons.create', compact('templateButtons','template_id'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('designer.templatebuttons.edit', compact('templateButtons','template_id'));
    }
