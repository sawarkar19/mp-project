...
class ContentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('designer.templates.show', compact('contents'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('designer.contents.create', compact('contents','template_id'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('designer.contents.edit', compact('contents','template_id'));
    }
