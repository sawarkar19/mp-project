...
class GalleryImageController extends Controller
{
    ...
    public function index()
    {
        $gallery_imgs = GalleryImage::orderBy('id', 'desc')
         ...
         return view('admin.templates.show', compact('gallery_imgs'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.galleryimages.create', compact('gallery_imgs','template_id'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.galleryimages.edit', compact('gallery_imgs','template_id'));
    }
