...
class MarketingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (empty($info)) {
            ...
            $data['gtm_container_id']=$request->gtm_container_id ?? '';
            $data['google_tag_manager_status']=$request->google_tag_manager_status ?? '';
            $info=new Option;
            ...
            $data['gtm_container_id']=$request->gtm_container_id ?? $old->gtm_container_id;
            $data['google_tag_manager_status']=$request->google_tag_manager_status ?? $old->google_tag_manager_status;
        }
        ...
        return response()->json(['Marketing information Updated']);
    }
