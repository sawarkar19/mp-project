...
class BusinessVcardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.vcards.index', compact('vcards', 'request', 'all', 'status', 'actives', 'inactives'));
    }
    ...
    {
        $vcards = [];
        return view('admin.vcards.create', compact('vcards'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.vcards.edit', compact('vcards'));
    }
