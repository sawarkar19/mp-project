...
class BlogController extends Controller
{
    ...
    public function create()
    {
        ...
        $selectTags = array();
        return view('admin.blog.create', compact('all_tags', 'selectTags'));
    }
    ...
    //     $image = $request->blog_banner;
    //     $input['blog_banner'] = time().'.'.$image->extension();
    ...
    public function edit($id)
    {
        ...
        return view('admin.blog.edit',compact('blogInfo', 'all_tags', 'selectTags'));
    }
    ...
    public function updateSettings3(Request $request){
        ...
        return json_encode(array("type"=>"success", "message"=>"Blog page SEO details are updated."));
        // dd($request);
    }
