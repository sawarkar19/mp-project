...
class ArticleController extends Controller
{
    ...
    public function create()
    {
        ...
        $selectTags = array();
        return view('admin.article.create', compact('all_tags', 'selectTags'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.article.edit',compact('articleInfo', 'all_tags', 'selectTags'));
    }
    ...
    public function settings(Request $request){
        ...
        return view('admin.article.settings', compact('settings'));
    }
