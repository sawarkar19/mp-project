...
class TemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // dd($templates);
        return view('admin.templates.index', compact('templates', 'request', 'all', 'status', 'actives', 'inactives'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.templates.create',compact('templates','types'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('admin.templates.show',compact('templates','gallery_imgs','contents', 'templateButtons'));
    }
    ...
    public function edit($id)
    {
        ...
        // dd($contact_icons);
        return view('admin.templates.edit',compact('templates','types','contact_icons'));
    }
