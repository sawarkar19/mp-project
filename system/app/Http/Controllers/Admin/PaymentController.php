...
class PaymentController extends Controller
{
    ...
    { 
        $posts=Category::where('type','payment_gateway')->where('display', '1')->with('preview')->withCount('gateway_users')->get();
    ...
    { 
        $info=Category::with('description','preview','credentials')->where('type','payment_gateway')->where('slug',$slug)->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        $info->featured=$request->featured ?? 1;
        ...
        if ($info->slug != 'cod') {
            ...
            if ($info->slug=='paytm') {
                ...
                $data['channel_id_web']=$request->channel_id_web;
                $data['channel_id_mobile']=$request->channel_id_mobile;
                $data['currency']=$request->currency;
            }
