...
class SiteController extends Controller
{
    public function site_settings()
    {
        ...
        return view('seo.settings.site_settings', compact('site_url', 'services_url', 'info', 'currency_name', 'currency_icon', 'order_prefix', 'currency_info', 'auto_order', 'tax', 'hsn_code', 'gst_code', 'igst_code', 'cgst_code', 'sgst_code'));
    }
    ...
    public function business_settings()
    {
        ...
        return view('seo.settings.business_settings', compact('guide_page', 'ask_for_invoice', 'invoice_required', 'ask_for_name', 'ask_for_dob', 'ask_for_anniversary_date', 'name_required', 'dob_required', 'anniversary_date_required', 'route_setting'));
    }
    ...
    public function system_environment_view()
    {
        ...
        return view('seo.settings.env', compact('countries', 'timezones'));
    }
