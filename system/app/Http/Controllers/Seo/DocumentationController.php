...
class DocumentationController extends Controller
{
    ...
    {    
        ...
        return view('seo.documentation.index',compact('documentations'));
    }
    ...
    public function create()
    {
        ...
        $selectTags = array();
        // dd($selectTags);
        return view('seo.documentation.create', compact('all_tags', 'selectTags'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // $documentation->featured = $request->featured;
        // dd($documentation);
        $documentation->save();
    ...
    public function edit($id)
    {
        ...
        return view('seo.documentation.edit',compact('documentationInfo', 'all_tags', 'selectTags'));
    }
    ...
    {
        // dd($request->file('documentation_banner'));
        $rules = [
            'title' => 'required|max:300', 
            'description' => 'required',
            'documentation_banner' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:1024',
    ...
    //     return view('seo.documentation.settings', compact('settings'));
    // }
