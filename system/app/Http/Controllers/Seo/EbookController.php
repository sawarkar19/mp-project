...
class EbookController extends Controller
{
    ...
    {    
        ...
        return view('seo.ebook.index',compact('ebooks'));
    }
    ...
    public function create()
    {
        ...
        $selectTags = array();
        return view('seo.ebook.create', compact('all_tags', 'selectTags'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('seo.ebook.edit',compact('ebookInfo', 'all_tags', 'selectTags'));
    }
    ...
    public function settings(Request $request){
        ...
        return view('seo.ebook.settings', compact('settings'));
    }
