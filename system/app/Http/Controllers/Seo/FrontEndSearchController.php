...
class FrontEndSearchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('seo.frontendsearch.index', compact('frontendSearch', 'conditions', 'frontendSearch', 'request'));
    }
    ...
    {
        return view('seo.frontendsearch.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('seo.frontendsearch.show', compact('FrontEndSearch'));
    }
    ...
    {
        $FrontEndSearch = FrontEndSearch::find($id);
        return view('seo.frontendsearch.edit', compact('FrontEndSearch'));
    }
