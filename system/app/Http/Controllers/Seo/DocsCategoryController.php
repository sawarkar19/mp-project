...
class DocsCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('seo.docscategories.index', compact('docscategories', 'request', 'all', 'status', 'actives', 'inactives'));
    }
    ...
    public function create()
    {
        ...
        return view('seo.docscategories.create', compact('docscategories'));
        // dd($channels);
    }
    ...
    public function show($id)
    {
        ...
        // return view('seo.channels.show', compact('channels'));
        // dd($channels);
    }
    ...
    public function edit($id)
    {
        ...
        // dd($docscategories);
        return view('seo.docscategories.edit', compact('docscategories'));
    }
